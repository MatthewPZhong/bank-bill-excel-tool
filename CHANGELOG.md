...
- 本地自动证据不能替代人工环境与资金复核。Windows installer/portable 实际运行、目标生产库的标准旧归档与触发行为、约 16 GB 数据库性能、约 700 万行多 Sheet 工具箱、跨盘符和网络路径、hardlink/copy/只读行为、Excel/WPS 打开与另存，以及真实主体×九币种、跨月、调整、归档/解归档/删除和审计结果仍待用户人工验收。
