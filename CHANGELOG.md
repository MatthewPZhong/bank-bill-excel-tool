...
> 自动化验证已完成：`release-check` 全绿（unit **3544/3544**、integration **40 个脚本 / 1870/1870**、smoke、ESLint），并完成 6 个月/15 万 MPT/6000 查询键基准、9 万行真实单据流读、启动性能和 Electron 预览。真实样本自动回放得到 **9 个成功组、1 个人工组**；**Windows Excel/WPS 人工打开及资金负责人复核尚未完成，当前不得标记为可发布。**
