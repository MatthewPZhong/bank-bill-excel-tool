...
- 当前应用版本仍为 3.2.6。实际切换须通过现有内存、磁盘、目录耐久、旧任务收口与五阶段升级检查；仅配置开启不等于用户数据已进入 ACTIVE。旧数据清理范围与 E5 恢复不变，详情见 `changes/v3.2.7/enablement`。
