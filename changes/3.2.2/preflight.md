...
- Context：功能 PR #184～#191 已按序合并，但 `package.json`/`package-lock.json` 仍为 `3.1.14`，顶层 `changes/3.2.2` 尚未进入版本分支。
...
- Done when：两处 package 版本均为 `3.2.2`；顶层 Spec/TechDoc 与冻结来源逐字节一致；`CHANGELOG.md`、`docs/VERSION_FEATURE_HISTORY.md`、`docs/USER_GUIDE.md` 同步记录本版能力与未解除的人工门禁；定向静态校验通过。
