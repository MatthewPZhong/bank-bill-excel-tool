...
3.2.6 最终状态及 PR #229 两次修复后均重跑 scan:vars 和 check:vars，更新 PR 前命中范围一致。交叉候选修复后的 release-check 退出码 0：lint、smoke、6942 项单测和全部 53 个集成脚本通过；3 项 Windows 专用单测在 macOS 跳过。
