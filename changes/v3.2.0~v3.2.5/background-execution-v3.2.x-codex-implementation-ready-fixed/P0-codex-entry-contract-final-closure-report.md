...
21 / 21 PASS
51 action policies
9 valid protocol messages
1 complete Service resource lifecycle sequence
5 valid RecoverySource kinds
58 version action-table rows
287 action-table ↔ Registry static-field comparisons
81 local contract references
58 hashed validation inputs
```
