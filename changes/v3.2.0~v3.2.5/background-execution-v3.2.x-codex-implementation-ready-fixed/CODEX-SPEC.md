...
- 恢复事务入口、transaction-scoped writer、observation event、command→event 映射、审计血缘、TaskRun/Batch/Critical Intent 边界通过 `recovery-control-transaction-contract-drift` 及其 10 个 mutation negative self-tests；
