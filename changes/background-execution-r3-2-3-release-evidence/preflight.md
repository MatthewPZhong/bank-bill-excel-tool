...
- Context：精确 parent 为已传播 E09-C review remediation 与 E09-P0 Windows path portability 修复的 E10-B head `9758ce887591ce41cac7c11d85cb690a5dadbccf`；R3.2.3 只交付 release evidence，不新增生产路径。
...
| 事实 | 证据 | 对方案的约束 |
| --- | --- | --- |
| exact parent 是已传播 E09-C review remediation 与 E09-P0 Windows path portability 修复的 E10-B head，冻结 Spec 恰有 Statement 5项与 NewAccount 2项。 | Git `9758ce88...`；v3.2.3 Spec §3/§11。 | action 集合、顺序与 parent 都是 exact authority。 |
