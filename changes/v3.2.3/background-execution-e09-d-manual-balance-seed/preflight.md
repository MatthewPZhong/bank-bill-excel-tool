...
- Constraints: review-fix restack exact base `f6a1bff5b538672895a20ac38ed339b054e7b823`; no E10 work; no second intent/receipt/Inspector/Publisher/config authority; `production.enabled=false`, `legacy`, worker count `0`; no `release-check`, `check-vars`, or `scan:vars`; funds/recovery remain human-gated.
