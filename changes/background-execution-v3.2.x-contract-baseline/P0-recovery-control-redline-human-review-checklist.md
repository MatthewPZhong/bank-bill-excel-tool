...
- [ ] 证明 Main 用真实 TaskPolicyRegistry 构造并保留生产 `ActionTaskBindingRegistry`；registry 仅一次读取并拥有完整 policy snapshot，source map JCS digest 为 `5c9ee53437d487a94ddb0f0d236dec7b07d4545452c9ebe3c6e98593de209ff2`，122-key recoverable inventory JCS digest 为 `9538102480f1a714f3839547f294fbe6fd1c19384734addd89dc0ca6e1dbb368`；Action Manifest v3 snapshot、61 条 pair provenance、TaskPolicy/call-site source hash 与 JCS KAT digest 均与本基线一致。
