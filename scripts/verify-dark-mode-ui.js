...
// DARK_MODE_UI_EVIDENCE_DIR 可指定本轮证据目录，避免覆盖源分支的历史验收记录。
...
const EVIDENCE = process.env.DARK_MODE_UI_EVIDENCE_DIR
  ? path.resolve(process.env.DARK_MODE_UI_EVIDENCE_DIR)
