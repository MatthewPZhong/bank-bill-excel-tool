...
const SOURCE_FILTER_CODES = Object.freeze({
  FUND_TRANSFER_NON_SUCCESS_EVIDENCE_INCOMPLETE:
    'FT_NON_SUCCESS_EVIDENCE_INCOMPLETE',
  TEST_PAYMENT_SOURCE_EVIDENCE_INCOMPLETE:
    'TEST_PAYMENT_SOURCE_EVIDENCE_INCOMPLETE'
});
