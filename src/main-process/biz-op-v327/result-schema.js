...
const RESULT_SCHEMA_VERSION = 'bizop-result-v1-e03';
...
module.exports = { RESULT_COLUMNS, NOTE_COLUMNS, RESULT_SCHEMA_VERSION, RESULT_SCHEMA, NOTES_SCHEMA, PART_SCHEMA };
