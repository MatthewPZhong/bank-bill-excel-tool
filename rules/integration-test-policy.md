...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-20T17:52:20+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 646 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 426 |
| `acquiring-engine-migration.js` | 45 | 45 | 4756 |
...
| `pending-engine-migration.js` | 57 | 57 | 5866 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 17745 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 16715 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2114 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 476 |
| `toolbox-roundtrip.js` | 30 | 30 | 230 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2070 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1518 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13908 |
...
| `v2.1.9-sr-log-1.js` | 33 | 33 | 139 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 217 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 206 |
