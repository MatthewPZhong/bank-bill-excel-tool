...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-11T18:11:03+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 680 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 457 |
| `acquiring-engine-migration.js` | 45 | 45 | 4854 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 198 |
| `acquiring-side-db-parity.js` | 19 | 19 | 529 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 309 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 259 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 263 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 291 |
| `big-table-import-engine.js` | 19 | 19 | 7597 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 311 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5227 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 347 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 196 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 192 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 182 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 181 |
| `new-account-balance-statement.js` | 36 | 36 | 261 |
| `pending-data-reconciliation.js` | 33 | 33 | 108 |
| `pending-engine-migration.js` | 57 | 57 | 5725 |
| `pending-removal-reconcile.js` | 62 | 62 | 232 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 296 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 309 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 349 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 241 |
| `statement-generation-pipeline.js` | 45 | 45 | 274 |
| `toolbox-large-file-stream.js` | 50 | 50 | 150478 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 164939 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 15990 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 492 |
| `toolbox-roundtrip.js` | 30 | 30 | 231 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2153 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1589 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13795 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 428 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 349 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2740 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 280 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 210 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 288 |
...
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1209 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1402 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 181 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1042 |
| **合计** | **2385** | **2385** | **388472** |
