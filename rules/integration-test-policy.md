...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-09-05T13:09:11+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 822 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 509 |
| `acquiring-engine-migration.js` | 45 | 45 | 4916 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 205 |
| `acquiring-side-db-parity.js` | 19 | 19 | 545 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 154 |
| `background-execution-recovery-canary.js` | 9 | 9 | 150 |
| `background-execution-recovery-control.js` | 27 | 27 | 128 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 282 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 491 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 318 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 245 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 243 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 293 |
| `big-table-import-engine.js` | 19 | 19 | 7592 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 335 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5798 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 363 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 217 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 211 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 210 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 208 |
| `new-account-balance-statement.js` | 36 | 36 | 269 |
| `pending-data-reconciliation.js` | 33 | 33 | 114 |
| `pending-engine-migration.js` | 57 | 57 | 5798 |
| `pending-removal-reconcile.js` | 62 | 62 | 245 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 304 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 313 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 358 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 251 |
| `statement-generation-pipeline.js` | 45 | 45 | 282 |
| `toolbox-large-file-stream.js` | 50 | 50 | 149069 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 250514 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16303 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 512 |
| `toolbox-roundtrip.js` | 30 | 30 | 233 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2405 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1755 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14272 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 607 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 445 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2796 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 293 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 237 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 302 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 195 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 207 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 242 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 286 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1268 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1476 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 199 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1066 |
| **合计** | **2488** | **2488** | **476851** |
