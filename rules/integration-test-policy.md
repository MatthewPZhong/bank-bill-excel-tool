...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-28T13:20:31+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 650 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 414 |
| `acquiring-engine-migration.js` | 45 | 45 | 4692 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 191 |
| `acquiring-side-db-parity.js` | 19 | 19 | 515 |
...
| `bizop-flow-engine-migration.js` | 65 | 65 | 5280 |
...
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 182 |
| `new-account-balance-statement.js` | 36 | 36 | 258 |
| `pending-data-reconciliation.js` | 33 | 33 | 109 |
| `pending-engine-migration.js` | 57 | 57 | 5791 |
...
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 266 |
| `statement-generation-pipeline.js` | 45 | 45 | 288 |
| `toolbox-large-file-stream.js` | 15 | 15 | 17562 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 16650 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2108 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 476 |
| `toolbox-roundtrip.js` | 30 | 30 | 230 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2090 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1502 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13696 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 359 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 290 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2717 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 273 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 198 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 287 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 142 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 239 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 207 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 229 |
| **合计** | **2016** | **2016** | **88951** |
