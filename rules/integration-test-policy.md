...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-27T18:53:14+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 244 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 214 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 215 |
| `new-account-balance-statement.js` | 36 | 36 | 242 |
| `pending-data-reconciliation.js` | 33 | 33 | 67 |
| `statement-generation-pipeline.js` | 45 | 45 | 235 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 225 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 101 |
| `v2.1.9-sr-fix-1-coverage.js` | 98 | 98 | 222 |
