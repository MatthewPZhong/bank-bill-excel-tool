...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-16T22:04:34+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 390 |
| `acquiring-engine-migration.js` | 45 | 45 | 4344 |
...
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 278 |
...
| `pending-engine-migration.js` | 57 | 57 | 5530 |
| `pending-removal-reconcile.js` | 62 | 62 | 239 |
| `statement-generation-pipeline.js` | 45 | 45 | 276 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1867 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1381 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13037 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 313 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 260 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2675 |
