...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-15T15:05:56+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 568 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 376 |
| `acquiring-engine-migration.js` | 45 | 45 | 4239 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 179 |
| `acquiring-side-db-parity.js` | 19 | 19 | 463 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 238 |
| `big-table-import-engine.js` | 19 | 19 | 7448 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4873 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 169 |
| `new-account-balance-statement.js` | 36 | 36 | 246 |
| `pending-data-reconciliation.js` | 33 | 33 | 89 |
| `pending-engine-migration.js` | 57 | 57 | 5276 |
| `pending-removal-reconcile.js` | 62 | 62 | 225 |
| `statement-generation-pipeline.js` | 45 | 45 | 264 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1842 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1362 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13079 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 292 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 245 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2655 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 270 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 181 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 262 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 126 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 173 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 177 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 198 |
| **合计** | **1344** | **1344** | **45515** |
