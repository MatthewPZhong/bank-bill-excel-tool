...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-31T00:05:12+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 730 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 480 |
| `acquiring-engine-migration.js` | 45 | 45 | 4167 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 172 |
| `acquiring-side-db-parity.js` | 19 | 19 | 516 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 98 |
| `background-execution-recovery-canary.js` | 9 | 9 | 147 |
| `background-execution-recovery-control.js` | 27 | 27 | 86 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 249 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 476 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 274 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 195 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 196 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 250 |
| `big-table-import-engine.js` | 19 | 19 | 7475 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 271 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 4793 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 316 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 163 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 172 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 163 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 166 |
| `new-account-balance-statement.js` | 36 | 36 | 216 |
| `pending-data-reconciliation.js` | 33 | 33 | 46 |
| `pending-engine-migration.js` | 57 | 57 | 4784 |
| `pending-removal-reconcile.js` | 62 | 62 | 188 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 240 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 250 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 296 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 184 |
| `statement-generation-pipeline.js` | 45 | 45 | 220 |
| `toolbox-large-file-stream.js` | 50 | 50 | 130961 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 160930 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 14704 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 444 |
| `toolbox-roundtrip.js` | 30 | 30 | 166 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2386 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1717 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13705 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 604 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 408 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2742 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 210 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 179 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 234 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 125 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 199 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 203 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 224 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1172 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1379 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 125 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1013 |
| **合计** | **2488** | **2488** | **361809** |
