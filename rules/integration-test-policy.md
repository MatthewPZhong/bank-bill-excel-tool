...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-01T20:32:38+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 636 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 428 |
| `acquiring-engine-migration.js` | 45 | 45 | 4654 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 190 |
| `acquiring-side-db-parity.js` | 19 | 19 | 496 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 300 |
...
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 282 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5162 |
...
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 160 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 158 |
| `new-account-balance-statement.js` | 36 | 36 | 246 |
| `pending-data-reconciliation.js` | 33 | 33 | 107 |
| `pending-engine-migration.js` | 57 | 57 | 5750 |
