...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-28T21:49:32+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 699 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 448 |
| `acquiring-engine-migration.js` | 45 | 45 | 4788 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 198 |
| `acquiring-side-db-parity.js` | 19 | 19 | 543 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 314 |
...
| `big-table-import-engine.js` | 19 | 19 | 7669 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 310 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5372 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 345 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 194 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 180 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 176 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 170 |
| `new-account-balance-statement.js` | 36 | 36 | 275 |
| `pending-data-reconciliation.js` | 33 | 33 | 108 |
| `pending-engine-migration.js` | 57 | 57 | 5914 |
...
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 366 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 255 |
| `statement-generation-pipeline.js` | 45 | 45 | 292 |
| `toolbox-large-file-stream.js` | 15 | 15 | 18954 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 17712 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2271 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 496 |
| `toolbox-roundtrip.js` | 30 | 30 | 240 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2236 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1632 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14763 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 403 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 301 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2824 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 282 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 245 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 323 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 169 |
