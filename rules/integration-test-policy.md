...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-09T07:28:16+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 404 |
| `acquiring-engine-migration.js` | 45 | 45 | 3782 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 156 |
...
| `big-table-import-engine.js` | 19 | 19 | 7508 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 248 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4314 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 288 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 145 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 151 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 144 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 143 |
| `new-account-balance-statement.js` | 36 | 36 | 225 |
| `pending-data-reconciliation.js` | 33 | 33 | 50 |
| `pending-engine-migration.js` | 57 | 57 | 4762 |
| `pending-removal-reconcile.js` | 62 | 62 | 196 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 244 |
...
| `statement-generation-pipeline.js` | 45 | 45 | 224 |
| `toolbox-large-file-stream.js` | 50 | 50 | 132416 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 72355 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 13572 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 458 |
| `toolbox-roundtrip.js` | 30 | 30 | 172 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2155 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1564 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13733 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 411 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 295 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2698 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 218 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 154 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 239 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 95 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 176 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 175 |
