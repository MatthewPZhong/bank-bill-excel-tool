...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-28T13:39:57+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 643 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 426 |
| `acquiring-engine-migration.js` | 45 | 45 | 4712 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 171 |
...
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 235 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 285 |
| `big-table-import-engine.js` | 19 | 19 | 7499 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 271 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5234 |
...
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 167 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 163 |
| `new-account-balance-statement.js` | 36 | 36 | 255 |
| `pending-data-reconciliation.js` | 33 | 33 | 114 |
| `pending-engine-migration.js` | 57 | 57 | 5855 |
| `pending-removal-reconcile.js` | 62 | 62 | 240 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 274 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 315 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 365 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 240 |
| `statement-generation-pipeline.js` | 45 | 45 | 290 |
| `toolbox-large-file-stream.js` | 15 | 15 | 17935 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 17005 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2104 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 471 |
| `toolbox-roundtrip.js` | 30 | 30 | 231 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2060 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1503 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13960 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 365 |
