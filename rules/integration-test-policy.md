...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-28T19:29:19+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 591 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 406 |
| `acquiring-engine-migration.js` | 45 | 45 | 4502 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 195 |
| `acquiring-side-db-parity.js` | 19 | 19 | 461 |
...
| `big-table-import-engine.js` | 19 | 19 | 7409 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 281 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4963 |
...
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 328 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 245 |
| `statement-generation-pipeline.js` | 45 | 45 | 273 |
| `toolbox-large-file-stream.js` | 15 | 15 | 16409 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 15862 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 1993 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 467 |
| `toolbox-roundtrip.js` | 30 | 30 | 231 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1894 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1436 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13145 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 358 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 278 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2688 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 261 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 199 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 272 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 155 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 201 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 195 |
