...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-09-12T14:26:40+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 1330 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 1131 |
| `acquiring-engine-migration.js` | 45 | 45 | 5668 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 196 |
| `acquiring-side-db-parity.js` | 19 | 19 | 603 |
| `archive-biz-op-auto-report-retention.js` | 6 | 6 | 10047 |
| `archive-center-module-retention.js` | 10 | 10 | 1457 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 136 |
| `background-execution-recovery-canary.js` | 9 | 9 | 150 |
| `background-execution-recovery-control.js` | 27 | 27 | 104 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 268 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 561 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 332 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 226 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 223 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 288 |
| `big-table-import-engine.js` | 19 | 19 | 7759 |
| `biz-op-auto-error-report.js` | 12 | 12 | 10141 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 333 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5649 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 415 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 193 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 207 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 196 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 209 |
| `new-account-balance-statement.js` | 36 | 36 | 279 |
| `pending-data-reconciliation.js` | 33 | 33 | 53 |
| `pending-engine-migration.js` | 57 | 57 | 5943 |
| `pending-removal-reconcile.js` | 62 | 62 | 207 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 270 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 277 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 329 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 204 |
| `statement-generation-pipeline.js` | 45 | 45 | 246 |
| `toolbox-large-file-stream.js` | 50 | 50 | 138269 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 78058 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 15323 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 488 |
| `toolbox-roundtrip.js` | 30 | 30 | 185 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2685 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1934 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14586 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 697 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 467 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2811 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 224 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 200 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 265 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 183 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 259 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 231 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 258 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1334 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1527 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 144 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1120 |
| **合计** | **2516** | **2516** | **316878** |
