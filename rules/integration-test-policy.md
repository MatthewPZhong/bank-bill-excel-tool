...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-28T20:15:30+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 601 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 411 |
| `acquiring-engine-migration.js` | 45 | 45 | 4581 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 199 |
| `acquiring-side-db-parity.js` | 19 | 19 | 471 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 309 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 261 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 264 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 250 |
| `big-table-import-engine.js` | 19 | 19 | 7451 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 296 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5016 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 309 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 192 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 170 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 158 |
...
| `pending-engine-migration.js` | 57 | 57 | 5662 |
| `pending-removal-reconcile.js` | 62 | 62 | 239 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 267 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 16890 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 15961 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2008 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 463 |
| `toolbox-roundtrip.js` | 30 | 30 | 237 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1915 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1441 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13416 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 365 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 304 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2693 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 284 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 206 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 272 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 160 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 200 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 196 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 201 |
| **合计** | **2016** | **2016** | **85998** |
