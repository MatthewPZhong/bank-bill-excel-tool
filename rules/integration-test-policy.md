...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-02T23:49:15+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 642 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 429 |
| `acquiring-engine-migration.js` | 45 | 45 | 4682 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 185 |
| `acquiring-side-db-parity.js` | 19 | 19 | 506 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 289 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 251 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 253 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 269 |
| `big-table-import-engine.js` | 19 | 19 | 7476 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 285 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5037 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 319 |
...
| `pending-engine-migration.js` | 57 | 57 | 5550 |
| `pending-removal-reconcile.js` | 62 | 62 | 226 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 294 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 293 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 335 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 235 |
| `statement-generation-pipeline.js` | 45 | 45 | 275 |
| `toolbox-large-file-stream.js` | 50 | 50 | 148194 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74343 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16534 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 494 |
| `toolbox-roundtrip.js` | 30 | 30 | 223 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2078 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1534 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13795 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 402 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 324 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2715 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 276 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 202 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 277 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 154 |
