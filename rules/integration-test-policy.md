...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-29T15:10:05+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 238 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 245 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 244 |
| `new-account-balance-statement.js` | 36 | 36 | 267 |
| `pending-data-reconciliation.js` | 33 | 33 | 113 |
| `pending-removal-reconcile.js` | 51 | 51 | 198 |
| `statement-generation-pipeline.js` | 45 | 45 | 235 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1096 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 714 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 24041 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 217 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 171 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 223 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 134 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 252 |
| `v2.1.9-sr-log-1.js` | 35 | 35 | 120 |
| **合计** | **943** | **943** | **28508** |
