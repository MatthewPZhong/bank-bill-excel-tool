...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-12T02:22:12+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 590 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 386 |
| `acquiring-engine-migration.js` | 45 | 45 | 4364 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 183 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 230 |
| `big-table-import-engine.js` | 19 | 19 | 7379 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4998 |
| `new-account-balance-statement.js` | 36 | 36 | 249 |
| `pending-data-reconciliation.js` | 33 | 33 | 88 |
| `pending-engine-migration.js` | 57 | 57 | 5467 |
| `pending-removal-reconcile.js` | 62 | 62 | 242 |
| `statement-generation-pipeline.js` | 45 | 45 | 269 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1833 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1359 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 12979 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 299 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 249 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2683 |
...
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 185 |
