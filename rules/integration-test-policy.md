...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-11T13:52:39+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 660 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 451 |
| `acquiring-engine-migration.js` | 45 | 45 | 4790 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 196 |
| `acquiring-side-db-parity.js` | 19 | 19 | 513 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 310 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 262 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 261 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 286 |
| `big-table-import-engine.js` | 19 | 19 | 7591 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 307 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5126 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 321 |
...
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 175 |
| `new-account-balance-statement.js` | 36 | 36 | 253 |
| `pending-data-reconciliation.js` | 33 | 33 | 110 |
| `pending-engine-migration.js` | 57 | 57 | 5731 |
| `pending-removal-reconcile.js` | 62 | 62 | 224 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 296 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 307 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 346 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 241 |
| `statement-generation-pipeline.js` | 45 | 45 | 277 |
| `toolbox-large-file-stream.js` | 50 | 50 | 147667 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 162443 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16976 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 510 |
| `toolbox-roundtrip.js` | 30 | 30 | 231 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2174 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1614 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14043 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 432 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 344 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2742 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 275 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 213 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 298 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 161 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 198 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 210 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 250 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1195 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1425 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 182 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1041 |
| **合计** | **2385** | **2385** | **384212** |
