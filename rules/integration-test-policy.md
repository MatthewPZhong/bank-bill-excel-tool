...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-01T13:47:23+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 235 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 237 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 245 |
| `new-account-balance-statement.js` | 36 | 36 | 267 |
| `pending-data-reconciliation.js` | 33 | 33 | 93 |
| `pending-removal-reconcile.js` | 62 | 62 | 205 |
| `statement-generation-pipeline.js` | 45 | 45 | 255 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1115 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 733 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 15337 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 211 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 178 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2448 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 240 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 124 |
