...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-17T04:33:01+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 447 |
| `acquiring-engine-migration.js` | 45 | 45 | 4862 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 199 |
| `acquiring-side-db-parity.js` | 19 | 19 | 488 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 305 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 256 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 255 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 281 |
| `big-table-import-engine.js` | 19 | 19 | 7355 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 301 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4951 |
...
| `pending-engine-migration.js` | 57 | 57 | 5515 |
| `pending-removal-reconcile.js` | 62 | 62 | 229 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 288 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 304 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 337 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 236 |
| `statement-generation-pipeline.js` | 45 | 45 | 269 |
| `toolbox-large-file-stream.js` | 50 | 50 | 139992 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 157014 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 15650 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 479 |
| `toolbox-roundtrip.js` | 30 | 30 | 229 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2031 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1542 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13492 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 454 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 352 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2711 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 277 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 224 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 278 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 166 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 188 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 210 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 243 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1128 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1353 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 191 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 960 |
| **合计** | **2385** | **2385** | **368077** |
