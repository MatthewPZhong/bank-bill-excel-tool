...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-24T19:53:54+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 512 |
| `acquiring-engine-migration.js` | 45 | 45 | 5106 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 229 |
| `acquiring-side-db-parity.js` | 19 | 19 | 555 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 167 |
| `background-execution-recovery-canary.js` | 9 | 9 | 145 |
| `background-execution-recovery-control.js` | 27 | 27 | 127 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 302 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 255 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 260 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 304 |
| `big-table-import-engine.js` | 19 | 19 | 7560 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 333 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5765 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 355 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 212 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 207 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 200 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 201 |
| `new-account-balance-statement.js` | 36 | 36 | 265 |
| `pending-data-reconciliation.js` | 33 | 33 | 110 |
| `pending-engine-migration.js` | 57 | 57 | 5752 |
| `pending-removal-reconcile.js` | 62 | 62 | 243 |
...
| `statement-generation-pipeline.js` | 45 | 45 | 279 |
| `toolbox-large-file-stream.js` | 50 | 50 | 149965 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 161897 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16720 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 501 |
| `toolbox-roundtrip.js` | 30 | 30 | 228 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2340 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1719 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13797 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 568 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 411 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2781 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 285 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 231 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 294 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 177 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 201 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 234 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 273 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1249 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1462 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 186 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1036 |
| **合计** | **2455** | **2455** | **387951** |
