...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-17T11:27:03+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 702 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 476 |
| `acquiring-engine-migration.js` | 45 | 45 | 5021 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 211 |
| `acquiring-side-db-parity.js` | 19 | 19 | 542 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 321 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 260 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 278 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 307 |
| `big-table-import-engine.js` | 19 | 19 | 7588 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 303 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5318 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 344 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 200 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 201 |
...
| `pending-data-reconciliation.js` | 33 | 33 | 109 |
| `pending-engine-migration.js` | 57 | 57 | 5909 |
...
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 356 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 253 |
| `statement-generation-pipeline.js` | 45 | 45 | 285 |
| `toolbox-large-file-stream.js` | 50 | 50 | 153488 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 76836 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17057 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 513 |
| `toolbox-roundtrip.js` | 30 | 30 | 230 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2276 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1675 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14427 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 487 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 380 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2876 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 278 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 214 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 294 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 199 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 197 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 219 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 254 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1266 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1476 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 185 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1074 |
| **合计** | **2385** | **2385** | **306394** |
