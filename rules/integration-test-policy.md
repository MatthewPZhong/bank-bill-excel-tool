...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-24T15:46:55+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 726 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 517 |
| `acquiring-engine-migration.js` | 45 | 45 | 5074 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 214 |
| `acquiring-side-db-parity.js` | 19 | 19 | 547 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 161 |
| `background-execution-recovery-control.js` | 27 | 27 | 129 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 294 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 263 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 260 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 305 |
| `big-table-import-engine.js` | 19 | 19 | 7582 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 333 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5763 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 355 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 211 |
...
| `new-account-balance-statement.js` | 36 | 36 | 264 |
| `pending-data-reconciliation.js` | 33 | 33 | 112 |
| `pending-engine-migration.js` | 57 | 57 | 5759 |
| `pending-removal-reconcile.js` | 62 | 62 | 244 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 299 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 317 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 352 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 250 |
| `statement-generation-pipeline.js` | 45 | 45 | 281 |
| `toolbox-large-file-stream.js` | 50 | 50 | 151286 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 163267 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16845 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 500 |
| `toolbox-roundtrip.js` | 30 | 30 | 228 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2353 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1709 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14092 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 562 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 413 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2768 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 289 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 228 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 294 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 177 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 200 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 230 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 266 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1261 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1442 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 189 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1058 |
| **合计** | **2446** | **2446** | **390884** |
