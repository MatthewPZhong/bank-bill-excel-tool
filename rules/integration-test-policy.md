...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-09T13:27:52+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 658 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 442 |
| `acquiring-engine-migration.js` | 45 | 45 | 4797 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 198 |
| `acquiring-side-db-parity.js` | 19 | 19 | 508 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 299 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 254 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 250 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 276 |
| `big-table-import-engine.js` | 19 | 19 | 7556 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 297 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5186 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 330 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 192 |
...
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 343 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 240 |
| `statement-generation-pipeline.js` | 45 | 45 | 274 |
| `toolbox-large-file-stream.js` | 50 | 50 | 146543 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 73109 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16640 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 485 |
| `toolbox-roundtrip.js` | 30 | 30 | 223 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2117 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1566 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14000 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 465 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 322 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2734 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 249 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 204 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 279 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 152 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 199 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 208 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 246 |
| `vcc-financial-op-adjustment-archive-chain.js` | 297 | 297 | 571 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1274 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 175 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 418 |
| **合计** | **2459** | **2459** | **291703** |
