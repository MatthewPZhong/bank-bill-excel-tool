...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-28T19:05:46+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 290 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 286 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 236 |
| `new-account-balance-statement.js` | 36 | 36 | 257 |
| `pending-data-reconciliation.js` | 33 | 33 | 98 |
| `statement-generation-pipeline.js` | 45 | 45 | 241 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1121 |
| `v2.1.10-a3-phase2.js` | 42 | 42 | 722 |
| `v2.1.10-a4-phase3.js` | 63 | 63 | 21926 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 431 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 215 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 237 |
