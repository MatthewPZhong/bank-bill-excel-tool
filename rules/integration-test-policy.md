...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-30T22:05:52+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 784 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 505 |
| `acquiring-engine-migration.js` | 45 | 45 | 4426 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 181 |
| `acquiring-side-db-parity.js` | 19 | 19 | 533 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 104 |
| `background-execution-recovery-canary.js` | 9 | 9 | 149 |
| `background-execution-recovery-control.js` | 27 | 27 | 93 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 262 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 499 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 291 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 206 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 207 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 275 |
| `big-table-import-engine.js` | 19 | 19 | 7559 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 300 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5086 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 335 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 173 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 187 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 175 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 176 |
| `new-account-balance-statement.js` | 36 | 36 | 230 |
| `pending-data-reconciliation.js` | 33 | 33 | 50 |
| `pending-engine-migration.js` | 57 | 57 | 5040 |
| `pending-removal-reconcile.js` | 62 | 62 | 212 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 253 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 266 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 315 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 197 |
| `statement-generation-pipeline.js` | 45 | 45 | 235 |
| `toolbox-large-file-stream.js` | 50 | 50 | 136123 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 165259 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 15268 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 461 |
| `toolbox-roundtrip.js` | 30 | 30 | 178 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2572 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1849 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14498 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 634 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 435 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2787 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 221 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 189 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 245 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 135 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 209 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 211 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 241 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1240 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1441 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 136 |
