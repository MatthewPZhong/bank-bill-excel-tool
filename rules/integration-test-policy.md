...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-09T05:34:37+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 622 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 378 |
| `acquiring-engine-migration.js` | 45 | 45 | 3500 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 145 |
| `acquiring-side-db-parity.js` | 19 | 19 | 452 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 236 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 185 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 180 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 211 |
| `big-table-import-engine.js` | 19 | 19 | 7333 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 232 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4002 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 268 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 132 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 138 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 131 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 133 |
| `new-account-balance-statement.js` | 36 | 36 | 203 |
| `pending-data-reconciliation.js` | 33 | 33 | 44 |
| `pending-engine-migration.js` | 57 | 57 | 4460 |
| `pending-removal-reconcile.js` | 62 | 62 | 175 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 224 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 237 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 274 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 173 |
| `statement-generation-pipeline.js` | 45 | 45 | 205 |
| `toolbox-large-file-stream.js` | 50 | 50 | 133160 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74120 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 14608 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 460 |
| `toolbox-roundtrip.js` | 30 | 30 | 178 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2208 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1610 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13780 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 428 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 303 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2706 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 213 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 161 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 239 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 96 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 178 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 180 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 208 |
| `vcc-financial-op-adjustment-archive-chain.js` | 295 | 295 | 513 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1215 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 386 |
| **合计** | **2438** | **2438** | **271223** |
