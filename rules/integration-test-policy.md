...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-01T18:23:22+08:00 -->
...
| `acquiring-engine-migration.js` | 45 | 45 | 4751 |
...
| `big-table-import-engine.js` | 19 | 19 | 7612 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 277 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5245 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 320 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 187 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 173 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 165 |
...
| `pending-engine-migration.js` | 57 | 57 | 5821 |
| `pending-removal-reconcile.js` | 62 | 62 | 236 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 298 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 150741 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 76080 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16720 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 508 |
| `toolbox-roundtrip.js` | 30 | 30 | 230 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2088 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1532 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13939 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 360 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 291 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2733 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 279 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 198 |
...
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 233 |
| **合计** | **2051** | **2051** | **296448** |
