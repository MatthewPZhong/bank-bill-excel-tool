...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-09T10:03:14+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 626 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 438 |
| `acquiring-engine-migration.js` | 45 | 45 | 4602 |
...
| `big-table-import-engine.js` | 19 | 19 | 7466 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 302 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4953 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 304 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 195 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 178 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 173 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 168 |
...
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 293 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 307 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 340 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 233 |
| `statement-generation-pipeline.js` | 45 | 45 | 278 |
| `toolbox-large-file-stream.js` | 50 | 50 | 145974 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 92143 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17581 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 510 |
| `toolbox-roundtrip.js` | 30 | 30 | 219 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2261 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1638 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14071 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 436 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 338 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2739 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 260 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 201 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 294 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 173 |
...
| `vcc-financial-op-adjustment-archive-chain.js` | 295 | 295 | 586 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1353 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 165 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 422 |
| **合计** | **2457** | **2457** | **310791** |
