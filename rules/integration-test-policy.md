...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-30T17:42:19+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 638 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 420 |
| `acquiring-engine-migration.js` | 45 | 45 | 4662 |
...
| `bank-statement-universal-import-routing.js` | 20 | 20 | 278 |
| `big-table-import-engine.js` | 19 | 19 | 7615 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 281 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5209 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 324 |
...
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 162 |
| `new-account-balance-statement.js` | 36 | 36 | 265 |
| `pending-data-reconciliation.js` | 33 | 33 | 105 |
| `pending-engine-migration.js` | 57 | 57 | 5743 |
| `pending-removal-reconcile.js` | 62 | 62 | 246 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 121431 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 71645 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 12396 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 507 |
| `toolbox-roundtrip.js` | 30 | 30 | 231 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2054 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1528 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13686 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 357 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 287 |
