...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-29T09:57:06+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 384 |
| `acquiring-engine-migration.js` | 45 | 45 | 4356 |
...
| `bank-statement-many-to-many-review-sheet.js` | 28 | 28 | 244 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 264 |
| `big-table-import-engine.js` | 19 | 19 | 7487 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 291 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4938 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 177 |
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 159 |
...
| `pending-data-reconciliation.js` | 33 | 33 | 95 |
| `pending-engine-migration.js` | 57 | 57 | 5513 |
| `pending-removal-reconcile.js` | 62 | 62 | 229 |
| `refund-backfill-yellow-fill-e2e.js` | 213 | 213 | 241 |
| `statement-generation-pipeline.js` | 45 | 45 | 269 |
| `toolbox-large-file-stream.js` | 15 | 15 | 16774 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 15685 |
| `toolbox-roundtrip.js` | 30 | 30 | 232 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1891 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1387 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13168 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 302 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 244 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2686 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 278 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 197 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 262 |
