...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-28T19:14:35+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 582 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 377 |
| `acquiring-engine-migration.js` | 45 | 45 | 4445 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 200 |
| `acquiring-side-db-parity.js` | 19 | 19 | 464 |
...
| `big-table-import-engine.js` | 19 | 19 | 7452 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 286 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5001 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 325 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 167 |
...
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 220 |
| `statement-generation-pipeline.js` | 45 | 45 | 276 |
| `toolbox-large-file-stream.js` | 15 | 15 | 16675 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 15917 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2041 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 453 |
| `toolbox-roundtrip.js` | 30 | 30 | 233 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1912 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1429 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13135 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 357 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 286 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2695 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 275 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 211 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 271 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 152 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 203 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 197 |
