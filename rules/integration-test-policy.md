...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-15T15:07:12+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 570 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 380 |
| `acquiring-engine-migration.js` | 45 | 45 | 4231 |
...
| `big-table-import-engine.js` | 19 | 19 | 7491 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 250 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 6085 |
...
| `pending-engine-migration.js` | 57 | 57 | 5284 |
| `pending-removal-reconcile.js` | 62 | 62 | 233 |
| `statement-generation-pipeline.js` | 45 | 45 | 245 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1953 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1472 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13799 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 339 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 211 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2646 |
...
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 229 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 173 |
