...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-30T22:02:36+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 681 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 437 |
| `acquiring-engine-migration.js` | 45 | 45 | 4637 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 187 |
...
| `bank-statement-universal-import-routing.js` | 20 | 20 | 274 |
| `big-table-import-engine.js` | 19 | 19 | 7607 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 288 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5229 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 335 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 182 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 177 |
...
| `pending-data-reconciliation.js` | 33 | 33 | 101 |
| `pending-engine-migration.js` | 57 | 57 | 5733 |
| `pending-removal-reconcile.js` | 62 | 62 | 249 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 291 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 156108 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 77558 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17719 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 528 |
| `toolbox-roundtrip.js` | 30 | 30 | 260 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 4431 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 2710 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 15201 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 391 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 300 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2744 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 269 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 204 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 301 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 148 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 214 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 201 |
