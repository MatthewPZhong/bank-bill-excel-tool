...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-20T18:03:19+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 653 |
...
| `acquiring-side-db-parity.js` | 19 | 19 | 511 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 312 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 265 |
...
| `pending-engine-migration.js` | 57 | 57 | 5918 |
| `pending-removal-reconcile.js` | 62 | 62 | 262 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 17898 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 16834 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2125 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 476 |
| `toolbox-roundtrip.js` | 30 | 30 | 232 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2067 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1521 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14185 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 371 |
