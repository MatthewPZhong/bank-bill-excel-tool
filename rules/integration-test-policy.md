...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-09-05T08:18:23+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 754 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 412 |
| `acquiring-engine-migration.js` | 45 | 45 | 3447 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 130 |
| `acquiring-side-db-parity.js` | 19 | 19 | 454 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 72 |
| `background-execution-recovery-canary.js` | 9 | 9 | 108 |
| `background-execution-recovery-control.js` | 27 | 27 | 70 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 201 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 387 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 239 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 165 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 166 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 209 |
| `big-table-import-engine.js` | 19 | 19 | 7311 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 231 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 3834 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 274 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 125 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 130 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 126 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 126 |
| `new-account-balance-statement.js` | 36 | 36 | 184 |
| `pending-data-reconciliation.js` | 33 | 33 | 19 |
| `pending-engine-migration.js` | 57 | 57 | 3846 |
| `pending-removal-reconcile.js` | 62 | 62 | 158 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 211 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 225 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 268 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 155 |
| `statement-generation-pipeline.js` | 45 | 45 | 187 |
| `toolbox-large-file-stream.js` | 50 | 50 | 149178 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 72850 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16947 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 426 |
| `toolbox-roundtrip.js` | 30 | 30 | 144 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2307 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1680 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14330 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 495 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 334 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2698 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 191 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 138 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 207 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 99 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 158 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 161 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 189 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1111 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1361 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 94 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 938 |
| **合计** | **2488** | **2488** | **290260** |
