...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-21T16:44:39+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 647 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 436 |
| `acquiring-engine-migration.js` | 45 | 45 | 4801 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 193 |
| `acquiring-side-db-parity.js` | 19 | 19 | 509 |
...
| `bizop-flow-engine-migration.js` | 65 | 65 | 5296 |
...
| `pending-engine-migration.js` | 57 | 57 | 5944 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 17701 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 16842 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2116 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 477 |
| `toolbox-roundtrip.js` | 30 | 30 | 233 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2080 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1536 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13537 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 360 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 294 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2722 |
