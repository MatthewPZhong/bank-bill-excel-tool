...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-11T08:08:02+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 571 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 377 |
| `acquiring-engine-migration.js` | 45 | 45 | 4254 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 183 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 216 |
| `big-table-import-engine.js` | 19 | 19 | 7445 |
| `bizop-flow-engine-migration.js` | 47 | 47 | 3521 |
| `new-account-balance-statement.js` | 36 | 36 | 253 |
| `pending-data-reconciliation.js` | 33 | 33 | 114 |
| `pending-engine-migration.js` | 45 | 45 | 4448 |
| `pending-removal-reconcile.js` | 62 | 62 | 238 |
| `statement-generation-pipeline.js` | 45 | 45 | 272 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1830 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1349 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13078 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 287 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 243 |
...
| `v2.1.9-sr-log-1.js` | 33 | 33 | 132 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 191 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 166 |
