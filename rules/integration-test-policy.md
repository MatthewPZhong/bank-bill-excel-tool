...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-09-12T13:38:16+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 808 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 521 |
| `acquiring-engine-migration.js` | 45 | 45 | 4626 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 189 |
| `acquiring-side-db-parity.js` | 19 | 19 | 588 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 121 |
| `background-execution-recovery-canary.js` | 9 | 9 | 122 |
| `background-execution-recovery-control.js` | 27 | 27 | 94 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 270 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 525 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 304 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 216 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 217 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 277 |
| `big-table-import-engine.js` | 19 | 19 | 7638 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 326 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5589 |
| `dark-mode-schedule-settings.js` | 6 | 6 | 198 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 366 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 188 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 195 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 186 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 186 |
| `new-account-balance-statement.js` | 36 | 36 | 247 |
| `pending-data-reconciliation.js` | 33 | 33 | 54 |
| `pending-engine-migration.js` | 57 | 57 | 5551 |
| `pending-removal-reconcile.js` | 62 | 62 | 216 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 275 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 281 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 333 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 205 |
| `statement-generation-pipeline.js` | 45 | 45 | 247 |
| `toolbox-large-file-stream.js` | 50 | 50 | 144694 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 271181 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 15869 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 514 |
| `toolbox-roundtrip.js` | 30 | 30 | 193 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2868 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 2032 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 15239 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 683 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 471 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2829 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 218 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 200 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 260 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 144 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 217 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 222 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 247 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1305 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1512 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 138 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1090 |
| **合计** | **2494** | **2494** | **493285** |
