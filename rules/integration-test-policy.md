...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-28T14:12:20+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 234 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 236 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 241 |
| `new-account-balance-statement.js` | 36 | 36 | 270 |
| `pending-data-reconciliation.js` | 33 | 33 | 113 |
| `statement-generation-pipeline.js` | 45 | 45 | 234 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1067 |
| `v2.1.10-a3-phase2.js` | 33 | 33 | 652 |
| `v2.1.10-a4-phase3.js` | 25 | 25 | 15921 |
| `v2.1.10-n4-cont-1-phase4.js` | 23 | 23 | 185 |
