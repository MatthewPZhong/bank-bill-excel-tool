...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-16T09:04:17+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 581 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 385 |
| `acquiring-engine-migration.js` | 45 | 45 | 4355 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 189 |
| `acquiring-side-db-parity.js` | 19 | 19 | 471 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 288 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 246 |
| `big-table-import-engine.js` | 19 | 19 | 7410 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 281 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4986 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 170 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 156 |
| `new-account-balance-statement.js` | 36 | 36 | 240 |
| `pending-data-reconciliation.js` | 33 | 33 | 110 |
| `pending-engine-migration.js` | 57 | 57 | 5492 |
| `pending-removal-reconcile.js` | 62 | 62 | 240 |
| `statement-generation-pipeline.js` | 45 | 45 | 267 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1847 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1393 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 12696 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 306 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 261 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2662 |
...
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 216 |
| **合计** | **1404** | **1404** | **46506** |
