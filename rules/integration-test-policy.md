...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-10T19:17:32+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 578 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 421 |
| `acquiring-engine-migration.js` | 34 | 34 | 3352 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 179 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 227 |
| `big-table-import-engine.js` | 19 | 19 | 7550 |
| `new-account-balance-statement.js` | 36 | 36 | 296 |
| `pending-data-reconciliation.js` | 33 | 33 | 112 |
| `pending-removal-reconcile.js` | 62 | 62 | 209 |
| `statement-generation-pipeline.js` | 45 | 45 | 267 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1855 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1376 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13228 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 275 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 238 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2697 |
