...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-31T02:41:25+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 618 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 400 |
| `acquiring-engine-migration.js` | 45 | 45 | 4490 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 181 |
| `acquiring-side-db-parity.js` | 19 | 19 | 490 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 282 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 246 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 246 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 269 |
| `big-table-import-engine.js` | 19 | 19 | 7484 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 276 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4975 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 320 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 162 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 174 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 174 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 166 |
| `new-account-balance-statement.js` | 36 | 36 | 238 |
| `pending-data-reconciliation.js` | 33 | 33 | 106 |
| `pending-engine-migration.js` | 57 | 57 | 5532 |
...
| `statement-generation-pipeline.js` | 45 | 45 | 267 |
| `toolbox-large-file-stream.js` | 50 | 50 | 147817 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 72855 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16421 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 481 |
| `toolbox-roundtrip.js` | 30 | 30 | 223 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1990 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1468 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13688 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 349 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 282 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2698 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 266 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 192 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 279 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 142 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 204 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 203 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 222 |
| **合计** | **2051** | **2051** | **288282** |
