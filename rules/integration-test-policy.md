...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-08T18:10:20+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 679 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 455 |
| `acquiring-engine-migration.js` | 45 | 45 | 4877 |
...
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 305 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5217 |
...
| `pending-engine-migration.js` | 57 | 57 | 5765 |
| `pending-removal-reconcile.js` | 62 | 62 | 235 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 312 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 317 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 347 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 242 |
| `statement-generation-pipeline.js` | 45 | 45 | 280 |
| `toolbox-large-file-stream.js` | 50 | 50 | 153655 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 77040 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16818 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 502 |
| `toolbox-roundtrip.js` | 30 | 30 | 227 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2178 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1609 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13994 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 453 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 353 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2744 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 269 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 208 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 288 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 150 |
...
| `vcc-financial-op-adjustment-archive-chain.js` | 55 | 55 | 508 |
| `vcc-financial-op-destructive-state-chain.js` | 52 | 52 | 1157 |
| **合计** | **2158** | **2158** | **302695** |
