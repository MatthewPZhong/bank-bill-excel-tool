...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-11T14:30:05+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 674 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 451 |
| `acquiring-engine-migration.js` | 45 | 45 | 4833 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 191 |
| `acquiring-side-db-parity.js` | 19 | 19 | 520 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 310 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 252 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 256 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 293 |
| `big-table-import-engine.js` | 19 | 19 | 7773 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 306 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5208 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 331 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 198 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 186 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 172 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 174 |
| `new-account-balance-statement.js` | 36 | 36 | 255 |
| `pending-data-reconciliation.js` | 33 | 33 | 110 |
| `pending-engine-migration.js` | 57 | 57 | 5722 |
| `pending-removal-reconcile.js` | 62 | 62 | 236 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 303 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 311 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 348 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 244 |
| `statement-generation-pipeline.js` | 45 | 45 | 281 |
| `toolbox-large-file-stream.js` | 50 | 50 | 146344 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 161667 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16519 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 488 |
| `toolbox-roundtrip.js` | 30 | 30 | 229 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2167 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1598 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13964 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 439 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 342 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2738 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 277 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 211 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 289 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 163 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 196 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 211 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 247 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1198 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1437 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 180 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1043 |
| **合计** | **2385** | **2385** | **381885** |
