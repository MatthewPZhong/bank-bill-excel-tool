...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-28T20:04:57+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 254 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 323 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 242 |
| `new-account-balance-statement.js` | 36 | 36 | 275 |
| `pending-data-reconciliation.js` | 33 | 33 | 111 |
| `statement-generation-pipeline.js` | 45 | 45 | 236 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1103 |
| `v2.1.10-a3-phase2.js` | 42 | 42 | 730 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 27137 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 310 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 209 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 246 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 142 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 252 |
| `v2.1.9-sr-log-1.js` | 35 | 35 | 123 |
| **合计** | **878** | **878** | **31693** |
