...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-31T03:31:49+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 698 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 450 |
| `acquiring-engine-migration.js` | 45 | 45 | 3926 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 162 |
| `acquiring-side-db-parity.js` | 19 | 19 | 479 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 92 |
| `background-execution-recovery-canary.js` | 9 | 9 | 144 |
| `background-execution-recovery-control.js` | 27 | 27 | 88 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 235 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 455 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 263 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 187 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 183 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 239 |
| `big-table-import-engine.js` | 19 | 19 | 7385 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 261 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 4542 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 297 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 156 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 161 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 157 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 157 |
| `new-account-balance-statement.js` | 36 | 36 | 206 |
| `pending-data-reconciliation.js` | 33 | 33 | 44 |
| `pending-engine-migration.js` | 57 | 57 | 4525 |
| `pending-removal-reconcile.js` | 62 | 62 | 179 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 226 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 236 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 281 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 174 |
| `statement-generation-pipeline.js` | 45 | 45 | 208 |
| `toolbox-large-file-stream.js` | 50 | 50 | 126332 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 155192 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 14218 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 427 |
| `toolbox-roundtrip.js` | 30 | 30 | 162 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2303 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1662 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13343 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 591 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 399 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2721 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 197 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 171 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 222 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 129 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 190 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 189 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 217 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1174 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1315 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 121 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 974 |
| **合计** | **2488** | **2488** | **349045** |
