...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-23T05:56:53+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 700 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 446 |
| `acquiring-engine-migration.js` | 45 | 45 | 3986 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 162 |
| `acquiring-side-db-parity.js` | 19 | 19 | 481 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 91 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 260 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 190 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 186 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 238 |
| `big-table-import-engine.js` | 19 | 19 | 7442 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 255 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 4609 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 295 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 153 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 156 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 154 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 153 |
| `new-account-balance-statement.js` | 36 | 36 | 210 |
| `pending-data-reconciliation.js` | 33 | 33 | 45 |
| `pending-engine-migration.js` | 57 | 57 | 4565 |
| `pending-removal-reconcile.js` | 62 | 62 | 178 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 230 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 239 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 280 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 176 |
| `statement-generation-pipeline.js` | 45 | 45 | 211 |
| `toolbox-large-file-stream.js` | 50 | 50 | 128232 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 70814 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 13908 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 429 |
| `toolbox-roundtrip.js` | 30 | 30 | 164 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2234 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1641 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13072 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 541 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 373 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2708 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 205 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 168 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 222 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 102 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 184 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 187 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 210 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1114 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1317 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 124 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 962 |
| **合计** | **2419** | **2419** | **265002** |
