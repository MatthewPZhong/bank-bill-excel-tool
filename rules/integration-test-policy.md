...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-17T17:56:47+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 662 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 437 |
| `acquiring-engine-migration.js` | 45 | 45 | 4847 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 195 |
| `acquiring-side-db-parity.js` | 19 | 19 | 507 |
...
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 293 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5377 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 336 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 195 |
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 179 |
...
| `pending-engine-migration.js` | 57 | 57 | 5982 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 18097 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 17090 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 482 |
| `toolbox-roundtrip.js` | 30 | 30 | 238 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2131 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1552 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14255 |
