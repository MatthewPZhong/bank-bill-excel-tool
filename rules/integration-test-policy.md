...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-11T06:59:13+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 567 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 360 |
| `acquiring-engine-migration.js` | 45 | 45 | 3893 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 138 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 224 |
| `big-table-import-engine.js` | 19 | 19 | 7433 |
| `new-account-balance-statement.js` | 36 | 36 | 254 |
| `pending-data-reconciliation.js` | 33 | 33 | 87 |
| `pending-removal-reconcile.js` | 62 | 62 | 186 |
| `statement-generation-pipeline.js` | 45 | 45 | 247 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1788 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1320 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 12964 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 253 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 210 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2637 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 262 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 159 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 250 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 107 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 166 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 155 |
| **合计** | **1099** | **1099** | **33660** |
