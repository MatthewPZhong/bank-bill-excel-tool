...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-09-05T15:35:03+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 736 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 519 |
| `acquiring-engine-migration.js` | 45 | 45 | 5247 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 228 |
| `acquiring-side-db-parity.js` | 19 | 19 | 555 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 177 |
| `background-execution-recovery-canary.js` | 9 | 9 | 170 |
| `background-execution-recovery-control.js` | 27 | 27 | 134 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 285 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 510 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 337 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 264 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 267 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 312 |
| `big-table-import-engine.js` | 19 | 19 | 7607 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 343 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5949 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 375 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 224 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 216 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 211 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 208 |
| `new-account-balance-statement.js` | 36 | 36 | 268 |
| `pending-data-reconciliation.js` | 33 | 33 | 118 |
| `pending-engine-migration.js` | 57 | 57 | 5880 |
| `pending-removal-reconcile.js` | 62 | 62 | 253 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 344 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 314 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 363 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 256 |
| `statement-generation-pipeline.js` | 45 | 45 | 294 |
| `toolbox-large-file-stream.js` | 50 | 50 | 149897 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 254432 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16324 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 501 |
| `toolbox-roundtrip.js` | 30 | 30 | 234 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2361 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1750 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14336 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 605 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 437 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2767 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 282 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 231 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 293 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 196 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 205 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 236 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 282 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1258 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1443 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 188 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1047 |
| **合计** | **2488** | **2488** | **482269** |
