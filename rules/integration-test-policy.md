...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-29T17:04:56+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 273 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 270 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 240 |
| `new-account-balance-statement.js` | 36 | 36 | 261 |
| `pending-data-reconciliation.js` | 33 | 33 | 85 |
| `pending-removal-reconcile.js` | 62 | 62 | 204 |
| `statement-generation-pipeline.js` | 45 | 45 | 250 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1266 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 776 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 28036 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 345 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 233 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 352 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 140 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 285 |
| `v2.1.9-sr-log-1.js` | 35 | 35 | 124 |
| **合计** | **954** | **954** | **33140** |
