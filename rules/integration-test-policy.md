...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-17T09:46:17+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 633 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 420 |
| `acquiring-engine-migration.js` | 45 | 45 | 4729 |
...
| `pending-engine-migration.js` | 57 | 57 | 5892 |
| `pending-removal-reconcile.js` | 62 | 62 | 257 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 17308 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 16581 |
...
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13606 |
