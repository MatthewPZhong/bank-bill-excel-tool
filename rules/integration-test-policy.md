...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-11T08:55:03+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 686 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 454 |
| `acquiring-engine-migration.js` | 45 | 45 | 4875 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 197 |
| `acquiring-side-db-parity.js` | 19 | 19 | 538 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 312 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 264 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 266 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 288 |
| `big-table-import-engine.js` | 19 | 19 | 7675 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 300 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5426 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 354 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 205 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 197 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 166 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 184 |
| `new-account-balance-statement.js` | 36 | 36 | 264 |
| `pending-data-reconciliation.js` | 33 | 33 | 94 |
| `pending-engine-migration.js` | 57 | 57 | 5899 |
| `pending-removal-reconcile.js` | 62 | 62 | 255 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 323 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 320 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 364 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 252 |
| `statement-generation-pipeline.js` | 45 | 45 | 302 |
| `toolbox-large-file-stream.js` | 50 | 50 | 159173 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 76680 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17569 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 514 |
| `toolbox-roundtrip.js` | 30 | 30 | 223 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2334 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1694 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14701 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 463 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 352 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2765 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 259 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 207 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 300 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 184 |
...
| `vcc-financial-op-adjustment-archive-chain.js` | 297 | 297 | 594 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1377 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 170 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 436 |
| **合计** | **2459** | **2459** | **311123** |
