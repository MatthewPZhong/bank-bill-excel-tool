...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-31T11:21:42+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 771 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 466 |
| `acquiring-engine-migration.js` | 45 | 45 | 3918 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 144 |
| `acquiring-side-db-parity.js` | 19 | 19 | 531 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 93 |
| `background-execution-recovery-canary.js` | 9 | 9 | 120 |
| `background-execution-recovery-control.js` | 27 | 27 | 78 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 246 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 505 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 268 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 190 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 193 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 238 |
| `big-table-import-engine.js` | 19 | 19 | 7513 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 258 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 4351 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 307 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 140 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 148 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 140 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 143 |
| `new-account-balance-statement.js` | 36 | 36 | 209 |
| `pending-data-reconciliation.js` | 33 | 33 | 22 |
| `pending-engine-migration.js` | 57 | 57 | 4425 |
| `pending-removal-reconcile.js` | 62 | 62 | 179 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 238 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 255 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 353 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 188 |
| `statement-generation-pipeline.js` | 45 | 45 | 219 |
| `toolbox-large-file-stream.js` | 50 | 50 | 161582 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 76473 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 18679 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 464 |
| `toolbox-roundtrip.js` | 30 | 30 | 158 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2629 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1856 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 15932 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 542 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 369 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2802 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 208 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 155 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 233 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 102 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 179 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 181 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 215 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1300 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1589 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 105 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1121 |
| **合计** | **2488** | **2488** | **313723** |
