...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-15T14:50:29+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 569 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 374 |
| `acquiring-engine-migration.js` | 45 | 45 | 4227 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 178 |
| `acquiring-side-db-parity.js` | 19 | 19 | 459 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 239 |
| `big-table-import-engine.js` | 19 | 19 | 7421 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4851 |
...
| `pending-engine-migration.js` | 57 | 57 | 5281 |
| `pending-removal-reconcile.js` | 62 | 62 | 212 |
| `statement-generation-pipeline.js` | 45 | 45 | 265 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1826 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1349 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13144 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 304 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 247 |
...
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 172 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 170 |
