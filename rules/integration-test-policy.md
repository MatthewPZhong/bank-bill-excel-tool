...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-09T08:36:49+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 675 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 412 |
| `acquiring-engine-migration.js` | 45 | 45 | 3738 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 155 |
| `acquiring-side-db-parity.js` | 19 | 19 | 487 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 256 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 201 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 197 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 232 |
| `big-table-import-engine.js` | 19 | 19 | 7432 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 254 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4267 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 293 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 143 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 151 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 145 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 146 |
| `new-account-balance-statement.js` | 36 | 36 | 222 |
| `pending-data-reconciliation.js` | 33 | 33 | 49 |
| `pending-engine-migration.js` | 57 | 57 | 4709 |
| `pending-removal-reconcile.js` | 62 | 62 | 199 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 251 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 256 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 295 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 184 |
| `statement-generation-pipeline.js` | 45 | 45 | 221 |
| `toolbox-large-file-stream.js` | 50 | 50 | 130347 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74093 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 14771 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 456 |
| `toolbox-roundtrip.js` | 30 | 30 | 174 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2150 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1568 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13619 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 413 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 299 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2702 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 224 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 158 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 241 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 110 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 178 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 179 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 205 |
| `vcc-financial-op-adjustment-archive-chain.js` | 295 | 295 | 509 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1223 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 122 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 393 |
| **合计** | **2457** | **2457** | **269704** |
