...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-28T18:41:53+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 600 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 415 |
| `acquiring-engine-migration.js` | 45 | 45 | 4511 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 202 |
| `acquiring-side-db-parity.js` | 19 | 19 | 465 |
...
| `big-table-import-engine.js` | 19 | 19 | 7480 |
...
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 154 |
| `new-account-balance-statement.js` | 36 | 36 | 241 |
| `pending-data-reconciliation.js` | 33 | 33 | 112 |
| `pending-engine-migration.js` | 57 | 57 | 5561 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 16739 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 15976 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2000 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 458 |
| `toolbox-roundtrip.js` | 30 | 30 | 235 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1934 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1417 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13185 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 357 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 292 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2667 |
