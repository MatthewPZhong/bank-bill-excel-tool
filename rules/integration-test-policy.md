...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-17T13:55:21+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 732 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 501 |
| `acquiring-engine-migration.js` | 45 | 45 | 5097 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 209 |
| `acquiring-side-db-parity.js` | 19 | 19 | 560 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 328 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 266 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 251 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 292 |
| `big-table-import-engine.js` | 19 | 19 | 7671 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 325 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5259 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 351 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 204 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 196 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 192 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 190 |
| `new-account-balance-statement.js` | 36 | 36 | 266 |
| `pending-data-reconciliation.js` | 33 | 33 | 113 |
| `pending-engine-migration.js` | 57 | 57 | 5724 |
| `pending-removal-reconcile.js` | 62 | 62 | 239 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 149561 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 164269 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16613 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 514 |
| `toolbox-roundtrip.js` | 30 | 30 | 233 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2226 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1632 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14060 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 472 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 363 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2758 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 286 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 213 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 293 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 161 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 194 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 216 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 259 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1212 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1450 |
