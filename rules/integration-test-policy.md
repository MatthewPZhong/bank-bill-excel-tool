...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-21T12:04:32+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 747 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 491 |
| `acquiring-engine-migration.js` | 45 | 45 | 5086 |
...
| `bank-statement-universal-import-routing.js` | 20 | 20 | 300 |
| `big-table-import-engine.js` | 19 | 19 | 7619 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 320 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5766 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 356 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 216 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 211 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 204 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 202 |
| `new-account-balance-statement.js` | 36 | 36 | 261 |
| `pending-data-reconciliation.js` | 33 | 33 | 106 |
| `pending-engine-migration.js` | 57 | 57 | 5779 |
| `pending-removal-reconcile.js` | 62 | 62 | 232 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 313 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 310 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 355 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 245 |
| `statement-generation-pipeline.js` | 45 | 45 | 282 |
| `toolbox-large-file-stream.js` | 50 | 50 | 158503 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 76986 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 18451 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 529 |
| `toolbox-roundtrip.js` | 30 | 30 | 229 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2573 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1885 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 15215 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 607 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 434 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2823 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 263 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 237 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 315 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 164 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 259 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 244 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 279 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1330 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1532 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 179 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1134 |
| **合计** | **2410** | **2410** | **315183** |
