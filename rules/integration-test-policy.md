...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-27T23:44:29+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 216 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 224 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 224 |
| `new-account-balance-statement.js` | 36 | 36 | 239 |
| `pending-data-reconciliation.js` | 33 | 33 | 68 |
| `statement-generation-pipeline.js` | 45 | 45 | 215 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 229 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 106 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 246 |
| `v2.1.9-sr-log-1.js` | 35 | 35 | 99 |
| **合计** | **645** | **645** | **1866** |
