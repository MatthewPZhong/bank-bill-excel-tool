...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-06T20:10:21+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 248 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 257 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 262 |
| `new-account-balance-statement.js` | 36 | 36 | 271 |
| `pending-data-reconciliation.js` | 33 | 33 | 112 |
| `pending-removal-reconcile.js` | 62 | 62 | 210 |
| `statement-generation-pipeline.js` | 45 | 45 | 273 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1068 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 731 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14742 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 226 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 187 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2541 |
