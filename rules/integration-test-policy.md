...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-11T01:52:23+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 708 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 464 |
| `acquiring-engine-migration.js` | 45 | 45 | 4938 |
...
| `big-table-import-engine.js` | 19 | 19 | 7646 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 313 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5331 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 343 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 200 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 196 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 181 |
...
| `pending-engine-migration.js` | 57 | 57 | 5896 |
| `pending-removal-reconcile.js` | 62 | 62 | 237 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 311 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 320 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 361 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 251 |
| `statement-generation-pipeline.js` | 45 | 45 | 287 |
| `toolbox-large-file-stream.js` | 50 | 50 | 153868 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 75699 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17070 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 508 |
| `toolbox-roundtrip.js` | 30 | 30 | 234 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2262 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1677 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14703 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 444 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 346 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2769 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 288 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 220 |
...
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 261 |
| `vcc-financial-op-adjustment-archive-chain.js` | 297 | 297 | 596 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1351 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 180 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 454 |
| **合计** | **2459** | **2459** | **304260** |
