...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-09T11:35:43+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 441 |
| `acquiring-engine-migration.js` | 45 | 45 | 4825 |
...
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 252 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 280 |
| `big-table-import-engine.js` | 19 | 19 | 7513 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 297 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5198 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 321 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 190 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 184 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 175 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 173 |
| `new-account-balance-statement.js` | 36 | 36 | 251 |
| `pending-data-reconciliation.js` | 33 | 33 | 106 |
| `pending-engine-migration.js` | 57 | 57 | 5734 |
| `pending-removal-reconcile.js` | 62 | 62 | 230 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 295 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 306 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 344 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 238 |
| `statement-generation-pipeline.js` | 45 | 45 | 273 |
| `toolbox-large-file-stream.js` | 50 | 50 | 149139 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 73324 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16347 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 492 |
| `toolbox-roundtrip.js` | 30 | 30 | 230 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2119 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1570 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13839 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 424 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 328 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2730 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 274 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 205 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 280 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 151 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 198 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 209 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 242 |
| `vcc-financial-op-adjustment-archive-chain.js` | 297 | 297 | 558 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1288 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 172 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 408 |
| **合计** | **2459** | **2459** | **294086** |
