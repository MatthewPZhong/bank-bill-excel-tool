...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-31T01:30:37+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 635 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 423 |
| `acquiring-engine-migration.js` | 45 | 45 | 4668 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 202 |
| `acquiring-side-db-parity.js` | 19 | 19 | 495 |
...
| `bank-statement-universal-import-routing.js` | 20 | 20 | 272 |
| `big-table-import-engine.js` | 19 | 19 | 7526 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 279 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5178 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 323 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 184 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 189 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 171 |
...
| `pending-engine-migration.js` | 57 | 57 | 5727 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 153332 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74414 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16938 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 501 |
| `toolbox-roundtrip.js` | 30 | 30 | 230 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2067 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1526 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13817 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 357 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 304 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2725 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 287 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 197 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 283 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 152 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 205 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 205 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 238 |
| **合计** | **2051** | **2051** | **297113** |
