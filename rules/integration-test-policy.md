...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-18T10:14:40+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 381 |
| `acquiring-engine-migration.js` | 45 | 45 | 4323 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 183 |
| `acquiring-side-db-parity.js` | 19 | 19 | 451 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 287 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 239 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 251 |
| `big-table-import-engine.js` | 19 | 19 | 7455 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 286 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4970 |
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 184 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 145 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 140 |
| `new-account-balance-statement.js` | 36 | 36 | 244 |
| `pending-data-reconciliation.js` | 33 | 33 | 115 |
| `pending-engine-migration.js` | 57 | 57 | 5484 |
| `pending-removal-reconcile.js` | 62 | 62 | 233 |
| `statement-generation-pipeline.js` | 45 | 45 | 280 |
| `toolbox-large-file-stream.js` | 15 | 15 | 16375 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 16109 |
| `toolbox-roundtrip.js` | 30 | 30 | 224 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1860 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1371 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13057 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 317 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 267 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2674 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 275 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 202 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 267 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 150 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 182 |
