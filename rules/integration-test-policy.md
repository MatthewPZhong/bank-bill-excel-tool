...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-17T12:39:59+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 655 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 423 |
| `acquiring-engine-migration.js` | 45 | 45 | 4718 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 190 |
| `acquiring-side-db-parity.js` | 19 | 19 | 492 |
...
| `big-table-import-engine.js` | 19 | 19 | 7515 |
...
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 187 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 17658 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 16699 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 469 |
| `toolbox-roundtrip.js` | 30 | 30 | 236 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2071 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1497 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13753 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 370 |
