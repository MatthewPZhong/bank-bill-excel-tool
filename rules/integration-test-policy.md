...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-24T13:34:59+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 762 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 486 |
| `acquiring-engine-migration.js` | 45 | 45 | 4367 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 178 |
| `acquiring-side-db-parity.js` | 19 | 19 | 545 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 107 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 292 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 210 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 208 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 262 |
| `big-table-import-engine.js` | 19 | 19 | 7553 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 287 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5111 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 323 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 166 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 176 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 170 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 171 |
| `new-account-balance-statement.js` | 36 | 36 | 233 |
| `pending-data-reconciliation.js` | 33 | 33 | 50 |
| `pending-engine-migration.js` | 57 | 57 | 5061 |
| `pending-removal-reconcile.js` | 62 | 62 | 222 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 257 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 268 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 310 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 191 |
| `statement-generation-pipeline.js` | 45 | 45 | 233 |
| `toolbox-large-file-stream.js` | 50 | 50 | 135446 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 167800 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 14951 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 469 |
| `toolbox-roundtrip.js` | 30 | 30 | 175 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2459 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1815 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14360 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 611 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 424 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2779 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 218 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 195 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 256 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 114 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 205 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 212 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 247 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1251 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1480 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 138 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1098 |
| **合计** | **2419** | **2419** | **374902** |
