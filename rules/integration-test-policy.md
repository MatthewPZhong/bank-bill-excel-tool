...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-28T22:07:34+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 709 |
...
| `acquiring-side-db-parity.js` | 19 | 19 | 536 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 308 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 277 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 283 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 293 |
| `big-table-import-engine.js` | 19 | 19 | 7666 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 298 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5397 |
...
| `new-account-balance-statement.js` | 36 | 36 | 285 |
| `pending-data-reconciliation.js` | 33 | 33 | 113 |
| `pending-engine-migration.js` | 57 | 57 | 5957 |
| `pending-removal-reconcile.js` | 62 | 62 | 249 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 298 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 325 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 369 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 250 |
| `statement-generation-pipeline.js` | 45 | 45 | 300 |
| `toolbox-large-file-stream.js` | 15 | 15 | 18819 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 17788 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2246 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 504 |
| `toolbox-roundtrip.js` | 30 | 30 | 233 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2235 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1633 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14536 |
...
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 299 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 144 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 246 |
