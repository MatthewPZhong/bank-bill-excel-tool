...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-19T00:42:00+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 765 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 521 |
| `acquiring-engine-migration.js` | 45 | 45 | 5310 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 220 |
| `acquiring-side-db-parity.js` | 19 | 19 | 595 |
...
| `bank-statement-universal-import-routing.js` | 20 | 20 | 319 |
| `big-table-import-engine.js` | 19 | 19 | 7642 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 345 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 6000 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 360 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 219 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 215 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 209 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 204 |
| `new-account-balance-statement.js` | 36 | 36 | 282 |
| `pending-data-reconciliation.js` | 33 | 33 | 107 |
| `pending-engine-migration.js` | 57 | 57 | 5963 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 156199 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 77126 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17362 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 513 |
| `toolbox-roundtrip.js` | 30 | 30 | 237 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2525 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1824 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14794 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 581 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 427 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2802 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 283 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 231 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 307 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 168 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 221 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 227 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 283 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1285 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1519 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 189 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1128 |
| **合计** | **2393** | **2393** | **312137** |
