...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-01T18:59:23+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 597 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 409 |
| `acquiring-engine-migration.js` | 45 | 45 | 4534 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 192 |
| `acquiring-side-db-parity.js` | 19 | 19 | 474 |
...
| `bank-statement-universal-import-routing.js` | 20 | 20 | 271 |
| `big-table-import-engine.js` | 19 | 19 | 7500 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 297 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5034 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 316 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 187 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 168 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 159 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 149 |
| `new-account-balance-statement.js` | 36 | 36 | 232 |
| `pending-data-reconciliation.js` | 33 | 33 | 111 |
| `pending-engine-migration.js` | 57 | 57 | 5594 |
| `pending-removal-reconcile.js` | 62 | 62 | 251 |
...
| `statement-generation-pipeline.js` | 45 | 45 | 262 |
| `toolbox-large-file-stream.js` | 50 | 50 | 143414 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 70835 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 15737 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 487 |
| `toolbox-roundtrip.js` | 30 | 30 | 233 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1949 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1446 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13227 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 352 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 295 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2692 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 282 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 202 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 273 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 156 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 187 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 192 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 203 |
| **合计** | **2051** | **2051** | **280892** |
