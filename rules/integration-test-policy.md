...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-16T22:41:41+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 586 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 391 |
| `acquiring-engine-migration.js` | 45 | 45 | 4390 |
...
| `big-table-import-engine.js` | 19 | 19 | 7496 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 287 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5218 |
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 192 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 133 |
...
| `pending-engine-migration.js` | 57 | 57 | 5469 |
| `pending-removal-reconcile.js` | 62 | 62 | 218 |
| `statement-generation-pipeline.js` | 45 | 45 | 276 |
| `toolbox-roundtrip.js` | 30 | 30 | 230 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1825 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1376 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13172 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 313 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 268 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2676 |
...
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 186 |
