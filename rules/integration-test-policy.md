...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-09T05:21:41+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 620 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 376 |
| `acquiring-engine-migration.js` | 45 | 45 | 3575 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 137 |
...
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 189 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 224 |
| `big-table-import-engine.js` | 19 | 19 | 7349 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 228 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4076 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 269 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 132 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 139 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 131 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 133 |
| `new-account-balance-statement.js` | 36 | 36 | 205 |
| `pending-data-reconciliation.js` | 33 | 33 | 45 |
| `pending-engine-migration.js` | 57 | 57 | 4470 |
| `pending-removal-reconcile.js` | 62 | 62 | 176 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 228 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 237 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 276 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 172 |
| `statement-generation-pipeline.js` | 45 | 45 | 219 |
| `toolbox-large-file-stream.js` | 50 | 50 | 125422 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 70905 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 14005 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 429 |
| `toolbox-roundtrip.js` | 30 | 30 | 168 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2042 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1485 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13190 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 398 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 299 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2665 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 206 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 149 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 223 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 89 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 165 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 167 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 194 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 114 |
| **合计** | **2070** | **2070** | **256799** |
