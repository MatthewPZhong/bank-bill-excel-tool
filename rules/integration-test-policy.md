...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-17T16:24:27+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 703 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 473 |
| `acquiring-engine-migration.js` | 45 | 45 | 4912 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 204 |
| `acquiring-side-db-parity.js` | 19 | 19 | 545 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 320 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 269 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 261 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 294 |
| `big-table-import-engine.js` | 19 | 19 | 7590 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 307 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5184 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 334 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 199 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 196 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 188 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 189 |
| `new-account-balance-statement.js` | 36 | 36 | 264 |
| `pending-data-reconciliation.js` | 33 | 33 | 108 |
| `pending-engine-migration.js` | 57 | 57 | 5706 |
| `pending-removal-reconcile.js` | 62 | 62 | 240 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 301 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 312 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 353 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 244 |
| `statement-generation-pipeline.js` | 45 | 45 | 280 |
| `toolbox-large-file-stream.js` | 50 | 50 | 152730 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 162048 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16790 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 500 |
| `toolbox-roundtrip.js` | 30 | 30 | 227 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2224 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1641 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14381 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 491 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 358 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2847 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 290 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 216 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 291 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 201 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 192 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 212 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 252 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1226 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1432 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 186 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1046 |
| **合计** | **2385** | **2385** | **389757** |
