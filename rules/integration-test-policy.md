...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-17T11:58:48+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 710 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 478 |
| `acquiring-engine-migration.js` | 45 | 45 | 5023 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 198 |
| `acquiring-side-db-parity.js` | 19 | 19 | 545 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 312 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 270 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 263 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 301 |
| `big-table-import-engine.js` | 19 | 19 | 7596 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 304 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5286 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 346 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 197 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 188 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 196 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 198 |
| `new-account-balance-statement.js` | 36 | 36 | 277 |
| `pending-data-reconciliation.js` | 33 | 33 | 105 |
| `pending-engine-migration.js` | 57 | 57 | 5850 |
| `pending-removal-reconcile.js` | 62 | 62 | 236 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 299 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 316 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 353 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 246 |
| `statement-generation-pipeline.js` | 45 | 45 | 278 |
| `toolbox-large-file-stream.js` | 50 | 50 | 150392 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 162880 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16788 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 504 |
| `toolbox-roundtrip.js` | 30 | 30 | 226 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2342 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1644 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14462 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 494 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 358 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2851 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 278 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 218 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 289 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 202 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 208 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 221 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 254 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1246 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1452 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 183 |
