...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-09-05T14:46:11+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 727 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 521 |
| `acquiring-engine-migration.js` | 45 | 45 | 5233 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 224 |
| `acquiring-side-db-parity.js` | 19 | 19 | 554 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 174 |
| `background-execution-recovery-canary.js` | 9 | 9 | 154 |
| `background-execution-recovery-control.js` | 27 | 27 | 131 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 266 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 501 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 338 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 268 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 267 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 311 |
| `big-table-import-engine.js` | 19 | 19 | 7560 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 341 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5848 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 386 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 227 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 217 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 216 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 217 |
| `new-account-balance-statement.js` | 36 | 36 | 283 |
| `pending-data-reconciliation.js` | 33 | 33 | 97 |
| `pending-engine-migration.js` | 57 | 57 | 5784 |
| `pending-removal-reconcile.js` | 62 | 62 | 242 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 294 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 314 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 352 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 251 |
| `statement-generation-pipeline.js` | 45 | 45 | 284 |
| `toolbox-large-file-stream.js` | 50 | 50 | 149755 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 75357 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16538 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 507 |
| `toolbox-roundtrip.js` | 30 | 30 | 233 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2334 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1737 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14242 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 607 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 440 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2765 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 289 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 232 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 296 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 196 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 202 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 233 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 274 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1214 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1424 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 186 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1030 |
| **合计** | **2488** | **2488** | **302673** |
