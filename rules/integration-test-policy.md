...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-13T03:26:03+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 645 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 418 |
...
| `big-table-import-engine.js` | 19 | 19 | 7575 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 285 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5225 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 180 |
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 169 |
...
| `pending-engine-migration.js` | 57 | 57 | 5836 |
| `pending-removal-reconcile.js` | 62 | 62 | 237 |
| `pre-fund-reconciliation-side-db-parity.js` | 37 | 37 | 137 |
| `refund-backfill-yellow-fill-e2e.js` | 213 | 213 | 216 |
| `statement-generation-pipeline.js` | 45 | 45 | 271 |
| `toolbox-large-file-stream.js` | 15 | 15 | 17722 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 16594 |
| `toolbox-roundtrip.js` | 30 | 30 | 233 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2050 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1505 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13620 |
