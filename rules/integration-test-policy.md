...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-17T09:46:46+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 731 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 492 |
| `acquiring-engine-migration.js` | 45 | 45 | 5149 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 206 |
| `acquiring-side-db-parity.js` | 19 | 19 | 563 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 340 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 270 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 321 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 304 |
| `big-table-import-engine.js` | 19 | 19 | 7710 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 308 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5392 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 358 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 205 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 199 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 176 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 200 |
| `new-account-balance-statement.js` | 36 | 36 | 274 |
| `pending-data-reconciliation.js` | 33 | 33 | 108 |
| `pending-engine-migration.js` | 57 | 57 | 5999 |
| `pending-removal-reconcile.js` | 62 | 62 | 250 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 306 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 323 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 359 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 251 |
| `statement-generation-pipeline.js` | 45 | 45 | 287 |
| `toolbox-large-file-stream.js` | 50 | 50 | 153249 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 75096 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17263 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 511 |
| `toolbox-roundtrip.js` | 30 | 30 | 232 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2373 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1744 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14419 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 497 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 376 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2772 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 280 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 223 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 309 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 176 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 205 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 228 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 253 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1243 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1533 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 199 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1105 |
| **合计** | **2385** | **2385** | **305367** |
