...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-11T13:17:01+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 669 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 450 |
| `acquiring-engine-migration.js` | 45 | 45 | 4800 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 194 |
| `acquiring-side-db-parity.js` | 19 | 19 | 521 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 306 |
...
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 295 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5138 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 321 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 195 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 185 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 182 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 172 |
| `new-account-balance-statement.js` | 36 | 36 | 254 |
| `pending-data-reconciliation.js` | 33 | 33 | 110 |
| `pending-engine-migration.js` | 57 | 57 | 5685 |
| `pending-removal-reconcile.js` | 62 | 62 | 231 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 300 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 308 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 349 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 241 |
| `statement-generation-pipeline.js` | 45 | 45 | 276 |
| `toolbox-large-file-stream.js` | 50 | 50 | 148782 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74039 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16103 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 483 |
| `toolbox-roundtrip.js` | 30 | 30 | 230 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2119 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1579 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13950 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 418 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 337 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2736 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 278 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 209 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 283 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 159 |
...
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1149 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1363 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 187 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1015 |
| **合计** | **2385** | **2385** | **295658** |
