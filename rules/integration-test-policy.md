...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-10T14:21:12+08:00 -->
...
| `acquiring-engine-migration.js` | 45 | 45 | 4775 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 192 |
| `acquiring-side-db-parity.js` | 19 | 19 | 568 |
...
| `big-table-import-engine.js` | 19 | 19 | 7678 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 299 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5230 |
...
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 193 |
| `new-account-balance-statement.js` | 36 | 36 | 270 |
| `pending-data-reconciliation.js` | 33 | 33 | 104 |
| `pending-engine-migration.js` | 57 | 57 | 5888 |
...
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 362 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 246 |
| `statement-generation-pipeline.js` | 45 | 45 | 287 |
| `toolbox-large-file-stream.js` | 50 | 50 | 160705 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 164559 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17085 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 525 |
| `toolbox-roundtrip.js` | 30 | 30 | 237 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2299 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1669 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14599 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 442 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 359 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2765 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 285 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 219 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 295 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 162 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 205 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 219 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 257 |
| `vcc-financial-op-adjustment-archive-chain.js` | 297 | 297 | 581 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1366 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 180 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 428 |
| **合计** | **2459** | **2459** | **399674** |
