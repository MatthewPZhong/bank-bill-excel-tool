...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-23T16:59:14+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 786 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 501 |
| `acquiring-engine-migration.js` | 45 | 45 | 4483 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 182 |
| `acquiring-side-db-parity.js` | 19 | 19 | 552 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 125 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 296 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 220 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 213 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 270 |
| `big-table-import-engine.js` | 19 | 19 | 7658 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 306 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5425 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 342 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 182 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 188 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 182 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 181 |
| `new-account-balance-statement.js` | 36 | 36 | 248 |
| `pending-data-reconciliation.js` | 33 | 33 | 54 |
| `pending-engine-migration.js` | 57 | 57 | 5351 |
| `pending-removal-reconcile.js` | 62 | 62 | 207 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 266 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 281 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 331 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 201 |
| `statement-generation-pipeline.js` | 45 | 45 | 244 |
| `toolbox-large-file-stream.js` | 50 | 50 | 138096 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 170470 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 15463 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 469 |
| `toolbox-roundtrip.js` | 30 | 30 | 181 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2457 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1828 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14291 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 610 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 403 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2772 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 228 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 182 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 252 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 114 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 205 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 207 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 237 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1276 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1484 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 135 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1093 |
| **合计** | **2419** | **2419** | **381728** |
