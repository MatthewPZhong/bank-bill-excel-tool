...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-09-06T23:44:27+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 753 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 531 |
| `acquiring-engine-migration.js` | 45 | 45 | 5369 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 231 |
| `acquiring-side-db-parity.js` | 19 | 19 | 566 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 178 |
| `background-execution-recovery-canary.js` | 9 | 9 | 175 |
| `background-execution-recovery-control.js` | 27 | 27 | 142 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 284 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 515 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 345 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 272 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 272 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 322 |
| `big-table-import-engine.js` | 19 | 19 | 7682 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 365 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 6029 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 382 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 229 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 224 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 213 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 204 |
| `new-account-balance-statement.js` | 36 | 36 | 290 |
| `pending-data-reconciliation.js` | 33 | 33 | 113 |
| `pending-engine-migration.js` | 57 | 57 | 6001 |
| `pending-removal-reconcile.js` | 62 | 62 | 254 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 315 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 330 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 367 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 257 |
| `statement-generation-pipeline.js` | 45 | 45 | 297 |
| `toolbox-large-file-stream.js` | 50 | 50 | 153214 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 249408 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17262 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 523 |
| `toolbox-roundtrip.js` | 30 | 30 | 242 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2453 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1811 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14398 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 652 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 453 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2815 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 295 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 243 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 309 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 207 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 216 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 249 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 294 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1268 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1496 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 194 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1079 |
| **合计** | **2488** | **2488** | **482588** |
