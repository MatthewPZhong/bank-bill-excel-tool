...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-08T06:56:24+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 258 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 278 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 228 |
| `new-account-balance-statement.js` | 36 | 36 | 248 |
| `pending-data-reconciliation.js` | 33 | 33 | 83 |
| `pending-removal-reconcile.js` | 62 | 62 | 187 |
| `statement-generation-pipeline.js` | 45 | 45 | 254 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1061 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 734 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13878 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 244 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 202 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2473 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 248 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 158 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 254 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 104 |
| **合计** | **952** | **952** | **20892** |
