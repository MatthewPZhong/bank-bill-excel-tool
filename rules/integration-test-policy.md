...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-04T18:10:00+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 606 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 411 |
| `acquiring-engine-migration.js` | 45 | 45 | 4594 |
...
| `bizop-flow-engine-migration.js` | 65 | 65 | 5097 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 180 |
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 163 |
...
| `pending-engine-migration.js` | 57 | 57 | 5756 |
| `pending-removal-reconcile.js` | 62 | 62 | 253 |
| `refund-backfill-yellow-fill-e2e.js` | 213 | 213 | 250 |
| `statement-generation-pipeline.js` | 45 | 45 | 270 |
| `toolbox-large-file-stream.js` | 15 | 15 | 16810 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 16057 |
| `toolbox-roundtrip.js` | 30 | 30 | 240 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1971 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1446 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13644 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 329 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 270 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2684 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 267 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 198 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 275 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 156 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 204 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 200 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 225 |
| **合计** | **1780** | **1780** | **82851** |
