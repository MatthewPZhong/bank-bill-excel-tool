...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-09-12T14:00:55+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 774 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 501 |
| `acquiring-engine-migration.js` | 45 | 45 | 4650 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 183 |
| `acquiring-side-db-parity.js` | 19 | 19 | 554 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 110 |
| `background-execution-recovery-canary.js` | 9 | 9 | 194 |
| `background-execution-recovery-control.js` | 27 | 27 | 100 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 274 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 526 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 304 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 219 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 208 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 267 |
| `big-table-import-engine.js` | 19 | 19 | 7580 |
| `biz-op-auto-error-report.js` | 12 | 12 | 11257 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 325 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5164 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 386 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 179 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 188 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 177 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 206 |
| `new-account-balance-statement.js` | 36 | 36 | 235 |
| `pending-data-reconciliation.js` | 33 | 33 | 55 |
| `pending-engine-migration.js` | 57 | 57 | 5269 |
| `pending-removal-reconcile.js` | 62 | 62 | 197 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 254 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 258 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 307 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 200 |
| `statement-generation-pipeline.js` | 45 | 45 | 246 |
| `toolbox-large-file-stream.js` | 50 | 50 | 142778 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 261859 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 15190 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 491 |
| `toolbox-roundtrip.js` | 30 | 30 | 184 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2828 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 2008 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14767 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 666 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 478 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2842 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 236 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 203 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 263 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 204 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 216 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 218 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 251 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1294 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1508 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 144 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1106 |
| **合计** | **2500** | **2500** | **491081** |
