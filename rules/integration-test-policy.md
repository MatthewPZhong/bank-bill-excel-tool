...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-23T00:24:13+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 628 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 425 |
| `acquiring-engine-migration.js` | 45 | 45 | 4829 |
...
| `big-table-import-engine.js` | 19 | 19 | 7568 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 303 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5327 |
...
| `pending-engine-migration.js` | 57 | 57 | 5894 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 17501 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 16720 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2090 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 476 |
| `toolbox-roundtrip.js` | 30 | 30 | 237 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2027 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1496 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13765 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 366 |
