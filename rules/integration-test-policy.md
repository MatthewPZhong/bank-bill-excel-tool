...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-24T21:55:19+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 778 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 537 |
| `acquiring-engine-migration.js` | 45 | 45 | 5398 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 231 |
| `acquiring-side-db-parity.js` | 19 | 19 | 582 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 173 |
| `background-execution-recovery-canary.js` | 9 | 9 | 151 |
| `background-execution-recovery-control.js` | 27 | 27 | 135 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 313 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 275 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 271 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 321 |
| `big-table-import-engine.js` | 19 | 19 | 7629 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 355 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 6126 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 381 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 222 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 225 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 218 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 210 |
| `new-account-balance-statement.js` | 36 | 36 | 287 |
| `pending-data-reconciliation.js` | 33 | 33 | 100 |
| `pending-engine-migration.js` | 57 | 57 | 6054 |
| `pending-removal-reconcile.js` | 62 | 62 | 252 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 315 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 331 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 370 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 254 |
| `statement-generation-pipeline.js` | 45 | 45 | 300 |
| `toolbox-large-file-stream.js` | 50 | 50 | 156421 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 79534 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17916 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 528 |
| `toolbox-roundtrip.js` | 30 | 30 | 236 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2533 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1924 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14736 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 616 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 442 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2814 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 265 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 246 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 314 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 181 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 226 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 250 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 289 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1330 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1518 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 196 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1129 |
| **合计** | **2455** | **2455** | **316438** |
