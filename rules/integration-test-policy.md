...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-21T11:55:13+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 663 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 439 |
| `acquiring-engine-migration.js` | 45 | 45 | 4890 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 200 |
| `acquiring-side-db-parity.js` | 19 | 19 | 539 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 329 |
...
| `pending-engine-migration.js` | 57 | 57 | 6099 |
| `pending-removal-reconcile.js` | 62 | 62 | 258 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 17941 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 17145 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2163 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 499 |
| `toolbox-roundtrip.js` | 30 | 30 | 237 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2126 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1572 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14395 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 387 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 308 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2850 |
...
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 217 |
