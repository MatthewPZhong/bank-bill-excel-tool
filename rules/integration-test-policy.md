...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-21T17:56:29+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 585 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 379 |
| `acquiring-engine-migration.js` | 45 | 45 | 4313 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 187 |
| `acquiring-side-db-parity.js` | 19 | 19 | 466 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 279 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 252 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 246 |
| `big-table-import-engine.js` | 19 | 19 | 7468 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 293 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4850 |
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 186 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 147 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 147 |
| `new-account-balance-statement.js` | 36 | 36 | 236 |
| `pending-data-reconciliation.js` | 33 | 33 | 109 |
| `pending-engine-migration.js` | 57 | 57 | 5432 |
| `pending-removal-reconcile.js` | 62 | 62 | 237 |
| `refund-backfill-yellow-fill-e2e.js` | 213 | 213 | 230 |
| `statement-generation-pipeline.js` | 45 | 45 | 258 |
| `toolbox-large-file-stream.js` | 15 | 15 | 16499 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 15600 |
| `toolbox-roundtrip.js` | 30 | 30 | 223 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1862 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1385 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13219 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 298 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 260 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2653 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 263 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 193 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 262 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 134 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 195 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 180 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 209 |
| **合计** | **1728** | **1728** | **79735** |
