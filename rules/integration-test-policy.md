...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-09-11T20:34:32+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 776 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 494 |
| `acquiring-engine-migration.js` | 45 | 45 | 4431 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 182 |
| `acquiring-side-db-parity.js` | 19 | 19 | 545 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 104 |
| `background-execution-recovery-canary.js` | 9 | 9 | 164 |
| `background-execution-recovery-control.js` | 27 | 27 | 95 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 263 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 504 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 291 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 209 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 204 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 270 |
| `big-table-import-engine.js` | 19 | 19 | 7571 |
| `biz-op-auto-error-report.js` | 12 | 12 | 9012 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 308 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5136 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 331 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 173 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 179 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 176 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 183 |
| `new-account-balance-statement.js` | 36 | 36 | 232 |
| `pending-data-reconciliation.js` | 33 | 33 | 49 |
| `pending-engine-migration.js` | 57 | 57 | 5101 |
| `pending-removal-reconcile.js` | 62 | 62 | 200 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 257 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 271 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 315 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 195 |
| `statement-generation-pipeline.js` | 45 | 45 | 235 |
| `toolbox-large-file-stream.js` | 50 | 50 | 132780 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 72872 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 14727 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 463 |
| `toolbox-roundtrip.js` | 30 | 30 | 170 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2398 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1758 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13687 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 631 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 409 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2751 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 211 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 176 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 231 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 130 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 197 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 196 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 223 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1178 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1355 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 125 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 993 |
| **合计** | **2500** | **2500** | **286117** |
