...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-24T18:56:34+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 661 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 469 |
| `acquiring-engine-migration.js` | 45 | 45 | 4827 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 211 |
| `acquiring-side-db-parity.js` | 19 | 19 | 502 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 152 |
| `background-execution-recovery-canary.js` | 9 | 9 | 154 |
| `background-execution-recovery-control.js` | 27 | 27 | 126 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 273 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 254 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 251 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 289 |
| `big-table-import-engine.js` | 19 | 19 | 7406 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 309 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5534 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 334 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 208 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 202 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 194 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 185 |
| `new-account-balance-statement.js` | 36 | 36 | 258 |
| `pending-data-reconciliation.js` | 33 | 33 | 108 |
| `pending-engine-migration.js` | 57 | 57 | 5540 |
| `pending-removal-reconcile.js` | 62 | 62 | 228 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 288 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 302 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 334 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 236 |
| `statement-generation-pipeline.js` | 45 | 45 | 269 |
| `toolbox-large-file-stream.js` | 50 | 50 | 141481 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 156425 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16111 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 479 |
| `toolbox-roundtrip.js` | 30 | 30 | 228 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2177 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1617 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13415 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 544 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 407 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2728 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 280 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 231 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 279 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 179 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 190 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 218 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 256 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1181 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1387 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 185 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 988 |
| **合计** | **2455** | **2455** | **371090** |
