...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-01T16:35:28+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 670 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 424 |
| `acquiring-engine-migration.js` | 45 | 45 | 4482 |
...
| `big-table-import-engine.js` | 19 | 19 | 7555 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 284 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5143 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 328 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 174 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 172 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 169 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 164 |
| `new-account-balance-statement.js` | 36 | 36 | 265 |
| `pending-data-reconciliation.js` | 33 | 33 | 101 |
| `pending-engine-migration.js` | 57 | 57 | 5644 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 154404 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74873 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16902 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 492 |
| `toolbox-roundtrip.js` | 30 | 30 | 225 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2042 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1522 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13816 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 349 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 287 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2705 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 274 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 194 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 283 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 149 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 199 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 198 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 231 |
| **合计** | **2051** | **2051** | **298181** |
