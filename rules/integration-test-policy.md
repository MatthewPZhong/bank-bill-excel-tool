...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-16T17:01:37+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 575 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 379 |
| `acquiring-engine-migration.js` | 45 | 45 | 4358 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 186 |
| `acquiring-side-db-parity.js` | 19 | 19 | 466 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 277 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 254 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 264 |
| `big-table-import-engine.js` | 19 | 19 | 7386 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 286 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4934 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 180 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 159 |
| `new-account-balance-statement.js` | 36 | 36 | 236 |
| `pending-data-reconciliation.js` | 33 | 33 | 111 |
| `pending-engine-migration.js` | 57 | 57 | 5389 |
| `pending-removal-reconcile.js` | 62 | 62 | 234 |
| `statement-generation-pipeline.js` | 45 | 45 | 271 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1843 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1372 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 12982 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 306 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 257 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2664 |
...
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 183 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 214 |
| **合计** | **1424** | **1424** | **46831** |
