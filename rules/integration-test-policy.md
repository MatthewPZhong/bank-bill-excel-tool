...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-22T00:51:41+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 905 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 521 |
| `acquiring-engine-migration.js` | 45 | 45 | 4936 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 200 |
| `acquiring-side-db-parity.js` | 19 | 19 | 542 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 313 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 267 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 269 |
...
| `bizop-flow-engine-migration.js` | 65 | 65 | 5305 |
...
| `new-account-balance-statement.js` | 36 | 36 | 276 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 18521 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 17711 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2291 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 517 |
| `toolbox-roundtrip.js` | 30 | 30 | 246 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2241 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1606 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14313 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 390 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 303 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2748 |
...
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 245 |
