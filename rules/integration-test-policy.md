...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-09T08:10:01+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 405 |
| `acquiring-engine-migration.js` | 45 | 45 | 3718 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 146 |
| `acquiring-side-db-parity.js` | 19 | 19 | 477 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 255 |
...
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 250 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4300 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 289 |
...
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 147 |
| `new-account-balance-statement.js` | 36 | 36 | 222 |
| `pending-data-reconciliation.js` | 33 | 33 | 47 |
| `pending-engine-migration.js` | 57 | 57 | 4719 |
...
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 187 |
| `statement-generation-pipeline.js` | 45 | 45 | 221 |
| `toolbox-large-file-stream.js` | 50 | 50 | 129121 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 73364 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 14663 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 455 |
| `toolbox-roundtrip.js` | 30 | 30 | 169 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2129 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1567 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13654 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 409 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 292 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2713 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 214 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 157 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 236 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 95 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 175 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 177 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 204 |
| `vcc-financial-op-adjustment-archive-chain.js` | 59 | 59 | 448 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1219 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 120 |
| **合计** | **2193** | **2193** | **267152** |
