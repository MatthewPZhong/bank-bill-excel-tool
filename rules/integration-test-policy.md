...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-09-19T00:04:31+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 878 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 649 |
| `acquiring-engine-migration.js` | 45 | 45 | 5923 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 279 |
| `acquiring-side-db-parity.js` | 19 | 19 | 608 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 171 |
| `background-execution-recovery-canary.js` | 9 | 9 | 211 |
| `background-execution-recovery-control.js` | 27 | 27 | 157 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 283 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 525 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 380 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 273 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 271 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 360 |
| `big-table-import-engine.js` | 19 | 19 | 7633 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 406 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5984 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 437 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 256 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 259 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 262 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 289 |
| `new-account-balance-statement.js` | 36 | 36 | 291 |
| `pending-data-reconciliation.js` | 33 | 33 | 117 |
| `pending-engine-migration.js` | 57 | 57 | 5981 |
| `pending-removal-reconcile.js` | 62 | 62 | 254 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 313 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 327 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 376 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 260 |
| `statement-generation-pipeline.js` | 45 | 45 | 291 |
| `toolbox-large-file-stream.js` | 50 | 50 | 152884 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 252725 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16969 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 519 |
| `toolbox-roundtrip.js` | 30 | 30 | 246 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2851 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 2087 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 15340 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 963 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 677 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2907 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 298 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 272 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 315 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 219 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 240 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 288 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 351 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1316 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1507 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 201 |
