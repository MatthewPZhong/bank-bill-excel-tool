...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-12T00:43:02+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 461 |
| `acquiring-engine-migration.js` | 45 | 45 | 4889 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 193 |
| `acquiring-side-db-parity.js` | 19 | 19 | 528 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 321 |
...
| `bizop-flow-engine-migration.js` | 65 | 65 | 5268 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 332 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 204 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 188 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 185 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 183 |
| `new-account-balance-statement.js` | 36 | 36 | 263 |
| `pending-data-reconciliation.js` | 33 | 33 | 117 |
| `pending-engine-migration.js` | 57 | 57 | 5808 |
| `pending-removal-reconcile.js` | 62 | 62 | 252 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 306 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 319 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 149367 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 161463 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16948 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 510 |
| `toolbox-roundtrip.js` | 30 | 30 | 235 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2176 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1600 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13784 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 429 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 348 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2746 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 293 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 221 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 293 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 172 |
...
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1185 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1410 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 187 |
