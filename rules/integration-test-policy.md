...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-03T00:08:01+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 667 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 446 |
| `acquiring-engine-migration.js` | 45 | 45 | 4841 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 202 |
| `acquiring-side-db-parity.js` | 19 | 19 | 519 |
...
| `big-table-import-engine.js` | 19 | 19 | 7579 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 290 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5199 |
...
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 169 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 169 |
| `new-account-balance-statement.js` | 36 | 36 | 246 |
| `pending-data-reconciliation.js` | 33 | 33 | 115 |
| `pending-engine-migration.js` | 57 | 57 | 5807 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 151684 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74814 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16786 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 500 |
| `toolbox-roundtrip.js` | 30 | 30 | 229 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2166 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1579 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13678 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 415 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 324 |
