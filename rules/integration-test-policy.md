...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-09T09:42:12+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 276 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 299 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 253 |
| `new-account-balance-statement.js` | 36 | 36 | 272 |
| `pending-data-reconciliation.js` | 33 | 33 | 107 |
| `pending-removal-reconcile.js` | 62 | 62 | 202 |
| `statement-generation-pipeline.js` | 45 | 45 | 249 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1090 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 763 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14003 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 274 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 214 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2486 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 269 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 189 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 258 |
