...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-08T20:10:34+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 712 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 455 |
| `acquiring-engine-migration.js` | 45 | 45 | 4859 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 194 |
| `acquiring-side-db-parity.js` | 19 | 19 | 534 |
...
| `big-table-import-engine.js` | 19 | 19 | 7657 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 296 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5259 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 333 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 208 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 196 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 180 |
...
| `pending-engine-migration.js` | 57 | 57 | 5793 |
| `pending-removal-reconcile.js` | 62 | 62 | 237 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 286 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 152583 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 72994 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17497 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 524 |
| `toolbox-roundtrip.js` | 30 | 30 | 233 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2193 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1617 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14031 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 436 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 337 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2753 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 287 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 211 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 289 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 156 |
...
| `vcc-financial-op-adjustment-archive-chain.js` | 55 | 55 | 515 |
| `vcc-financial-op-destructive-state-chain.js` | 52 | 52 | 1172 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 438 |
| **合计** | **2186** | **2186** | **298972** |
