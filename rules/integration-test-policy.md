...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-17T10:56:50+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 706 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 527 |
| `acquiring-engine-migration.js` | 45 | 45 | 4970 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 204 |
| `acquiring-side-db-parity.js` | 19 | 19 | 550 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 319 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 256 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 260 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 295 |
| `big-table-import-engine.js` | 19 | 19 | 7585 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 309 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5263 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 349 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 198 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 200 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 195 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 187 |
| `new-account-balance-statement.js` | 36 | 36 | 270 |
| `pending-data-reconciliation.js` | 33 | 33 | 104 |
| `pending-engine-migration.js` | 57 | 57 | 5757 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 155036 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 165000 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17016 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 513 |
| `toolbox-roundtrip.js` | 30 | 30 | 232 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2348 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1726 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14572 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 496 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 363 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2879 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 297 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 226 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 315 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 199 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 214 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 237 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 260 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1253 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1457 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 183 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1112 |
| **合计** | **2385** | **2385** | **396171** |
