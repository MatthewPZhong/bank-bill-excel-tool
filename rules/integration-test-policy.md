...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-18T10:32:32+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 595 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 380 |
| `acquiring-engine-migration.js` | 45 | 45 | 4425 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 181 |
| `acquiring-side-db-parity.js` | 19 | 19 | 478 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 295 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 248 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 256 |
| `big-table-import-engine.js` | 19 | 19 | 7473 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 295 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5005 |
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 182 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 154 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 151 |
| `new-account-balance-statement.js` | 36 | 36 | 245 |
| `pending-data-reconciliation.js` | 33 | 33 | 111 |
| `pending-engine-migration.js` | 57 | 57 | 5517 |
| `pending-removal-reconcile.js` | 62 | 62 | 240 |
| `statement-generation-pipeline.js` | 45 | 45 | 278 |
| `toolbox-large-file-stream.js` | 15 | 15 | 16800 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 15890 |
| `toolbox-roundtrip.js` | 30 | 30 | 231 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1909 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1423 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13744 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 321 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 272 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2777 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 282 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 195 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 269 |
