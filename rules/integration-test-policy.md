...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-28T13:28:32+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 224 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 216 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 214 |
| `new-account-balance-statement.js` | 36 | 36 | 229 |
| `pending-data-reconciliation.js` | 33 | 33 | 69 |
| `statement-generation-pipeline.js` | 45 | 45 | 230 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1036 |
| `v2.1.10-a3-phase2.js` | 33 | 33 | 615 |
| `v2.1.10-a4-phase3.js` | 25 | 25 | 16850 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 162 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 216 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 106 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 243 |
| `v2.1.9-sr-log-1.js` | 35 | 35 | 87 |
| **合计** | **786** | **786** | **20497** |
