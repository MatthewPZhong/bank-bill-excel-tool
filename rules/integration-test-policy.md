...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-04T23:36:28+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 401 |
| `acquiring-engine-migration.js` | 45 | 45 | 4515 |
...
| `big-table-import-engine.js` | 19 | 19 | 7483 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 296 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5067 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 194 |
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 165 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 147 |
...
| `pending-engine-migration.js` | 57 | 57 | 5751 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 16425 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 15575 |
| `toolbox-roundtrip.js` | 30 | 30 | 235 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1882 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1395 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13225 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 316 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 269 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2690 |
...
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 221 |
| **合计** | **1780** | **1780** | **81209** |
