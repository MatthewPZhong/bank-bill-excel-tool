...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-15T15:37:54+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 583 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 397 |
| `acquiring-engine-migration.js` | 45 | 45 | 4424 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 186 |
| `acquiring-side-db-parity.js` | 19 | 19 | 470 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 286 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 260 |
| `big-table-import-engine.js` | 19 | 19 | 7488 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 299 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5107 |
...
| `pending-engine-migration.js` | 57 | 57 | 5548 |
| `pending-removal-reconcile.js` | 62 | 62 | 240 |
| `statement-generation-pipeline.js` | 45 | 45 | 275 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1850 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1367 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13092 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 313 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 257 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2682 |
