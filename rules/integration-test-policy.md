...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-11T18:39:48+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 656 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 451 |
| `acquiring-engine-migration.js` | 45 | 45 | 4792 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 192 |
| `acquiring-side-db-parity.js` | 19 | 19 | 526 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 309 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 248 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 254 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 285 |
| `big-table-import-engine.js` | 19 | 19 | 7524 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 298 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5148 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 325 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 193 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 193 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 179 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 178 |
| `new-account-balance-statement.js` | 36 | 36 | 250 |
| `pending-data-reconciliation.js` | 33 | 33 | 106 |
| `pending-engine-migration.js` | 57 | 57 | 5672 |
| `pending-removal-reconcile.js` | 62 | 62 | 228 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 295 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 309 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 349 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 242 |
| `statement-generation-pipeline.js` | 45 | 45 | 277 |
| `toolbox-large-file-stream.js` | 50 | 50 | 151819 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74179 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16595 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 492 |
| `toolbox-roundtrip.js` | 30 | 30 | 229 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2136 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1590 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13585 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 428 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 339 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2726 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 277 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 216 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 281 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 162 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 196 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 212 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 249 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1166 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1417 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 177 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1034 |
| **合计** | **2385** | **2385** | **298984** |
