...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-28T17:53:26+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 260 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 265 |
...
| `statement-generation-pipeline.js` | 45 | 45 | 242 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1135 |
| `v2.1.10-a3-phase2.js` | 33 | 33 | 687 |
| `v2.1.10-a4-phase3.js` | 47 | 47 | 20873 |
| `v2.1.10-n4-cont-1-phase4.js` | 28 | 28 | 272 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 211 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 242 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 153 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 312 |
| `v2.1.9-sr-log-1.js` | 35 | 35 | 117 |
| **合计** | **836** | **836** | **25377** |
