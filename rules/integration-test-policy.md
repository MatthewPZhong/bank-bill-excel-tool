...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-24T16:49:04+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 713 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 513 |
| `acquiring-engine-migration.js` | 45 | 45 | 5079 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 215 |
| `acquiring-side-db-parity.js` | 19 | 19 | 544 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 163 |
| `background-execution-recovery-canary.js` | 9 | 9 | 159 |
| `background-execution-recovery-control.js` | 27 | 27 | 131 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 289 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 247 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 259 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 301 |
| `big-table-import-engine.js` | 19 | 19 | 7561 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 322 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5726 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 359 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 215 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 212 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 205 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 199 |
| `new-account-balance-statement.js` | 36 | 36 | 265 |
| `pending-data-reconciliation.js` | 33 | 33 | 111 |
| `pending-engine-migration.js` | 57 | 57 | 5728 |
| `pending-removal-reconcile.js` | 62 | 62 | 242 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 302 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 314 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 352 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 245 |
| `statement-generation-pipeline.js` | 45 | 45 | 283 |
| `toolbox-large-file-stream.js` | 50 | 50 | 152404 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74235 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16737 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 500 |
| `toolbox-roundtrip.js` | 30 | 30 | 229 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2322 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1711 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14154 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 564 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 419 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2761 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 269 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 229 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 292 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 178 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 202 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 227 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 267 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1228 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1435 |
