...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-30T23:30:54+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 796 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 509 |
| `acquiring-engine-migration.js` | 45 | 45 | 4473 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 181 |
| `acquiring-side-db-parity.js` | 19 | 19 | 549 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 108 |
| `background-execution-recovery-canary.js` | 9 | 9 | 134 |
| `background-execution-recovery-control.js` | 27 | 27 | 93 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 258 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 515 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 298 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 211 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 209 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 270 |
| `big-table-import-engine.js` | 19 | 19 | 7626 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 291 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5199 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 341 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 176 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 184 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 177 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 180 |
| `new-account-balance-statement.js` | 36 | 36 | 235 |
| `pending-data-reconciliation.js` | 33 | 33 | 51 |
| `pending-engine-migration.js` | 57 | 57 | 5141 |
| `pending-removal-reconcile.js` | 62 | 62 | 202 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 258 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 269 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 317 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 198 |
| `statement-generation-pipeline.js` | 45 | 45 | 237 |
| `toolbox-large-file-stream.js` | 50 | 50 | 140699 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 165090 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 15117 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 479 |
| `toolbox-roundtrip.js` | 30 | 30 | 182 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2617 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1892 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14637 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 660 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 440 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2785 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 220 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 191 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 253 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 140 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 212 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 215 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 247 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1257 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1470 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 138 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1078 |
| **合计** | **2488** | **2488** | **379705** |
