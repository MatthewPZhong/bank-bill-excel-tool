...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-28T23:14:02+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 396 |
| `acquiring-engine-migration.js` | 45 | 45 | 4179 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 157 |
| `acquiring-side-db-parity.js` | 19 | 19 | 508 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 276 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 234 |
| `bank-statement-many-to-many-review-sheet.js` | 24 | 24 | 232 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 249 |
| `big-table-import-engine.js` | 19 | 19 | 7603 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 260 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4756 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 150 |
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 157 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 151 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 154 |
| `new-account-balance-statement.js` | 36 | 36 | 251 |
| `pending-data-reconciliation.js` | 33 | 33 | 74 |
| `pending-engine-migration.js` | 57 | 57 | 5272 |
| `pending-removal-reconcile.js` | 62 | 62 | 218 |
| `refund-backfill-yellow-fill-e2e.js` | 213 | 213 | 220 |
| `statement-generation-pipeline.js` | 45 | 45 | 255 |
| `toolbox-large-file-stream.js` | 15 | 15 | 18213 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 17387 |
| `toolbox-roundtrip.js` | 30 | 30 | 199 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2113 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1535 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14414 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 318 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 242 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2694 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 239 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 164 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 271 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 103 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 234 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 188 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 212 |
| **合计** | **1771** | **1771** | **84955** |
