...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-06T17:54:33+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 232 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 261 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 258 |
| `new-account-balance-statement.js` | 36 | 36 | 275 |
| `pending-data-reconciliation.js` | 33 | 33 | 112 |
| `pending-removal-reconcile.js` | 62 | 62 | 199 |
| `statement-generation-pipeline.js` | 45 | 45 | 253 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1097 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 753 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14742 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 226 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 183 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2449 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 281 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 139 |
