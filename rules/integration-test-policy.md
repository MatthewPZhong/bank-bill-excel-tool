...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-31T12:10:58+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 755 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 465 |
| `acquiring-engine-migration.js` | 45 | 45 | 3891 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 145 |
| `acquiring-side-db-parity.js` | 19 | 19 | 529 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 94 |
| `background-execution-recovery-canary.js` | 9 | 9 | 103 |
| `background-execution-recovery-control.js` | 27 | 27 | 76 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 228 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 438 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 266 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 191 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 192 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 233 |
| `big-table-import-engine.js` | 19 | 19 | 7559 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 260 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 4367 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 304 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 140 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 148 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 139 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 141 |
| `new-account-balance-statement.js` | 36 | 36 | 209 |
| `pending-data-reconciliation.js` | 33 | 33 | 21 |
| `pending-engine-migration.js` | 57 | 57 | 4419 |
| `pending-removal-reconcile.js` | 62 | 62 | 179 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 240 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 256 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 302 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 174 |
| `statement-generation-pipeline.js` | 45 | 45 | 214 |
| `toolbox-large-file-stream.js` | 50 | 50 | 161325 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 78461 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 18573 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 470 |
| `toolbox-roundtrip.js` | 30 | 30 | 161 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2637 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1907 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 15774 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 544 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 377 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2796 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 203 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 249 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 232 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 107 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 177 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 182 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 210 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1264 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1531 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 111 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1124 |
| **合计** | **2488** | **2488** | **315093** |
