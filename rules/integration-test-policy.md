...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-09T15:55:37+08:00 -->
...
| `acquiring-engine-migration.js` | 45 | 45 | 4845 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 189 |
| `acquiring-side-db-parity.js` | 19 | 19 | 522 |
...
| `big-table-import-engine.js` | 19 | 19 | 7620 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 285 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5210 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 329 |
...
| `pending-data-reconciliation.js` | 33 | 33 | 103 |
| `pending-engine-migration.js` | 57 | 57 | 5739 |
| `pending-removal-reconcile.js` | 62 | 62 | 228 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 292 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 306 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 344 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 240 |
| `statement-generation-pipeline.js` | 45 | 45 | 273 |
| `toolbox-large-file-stream.js` | 50 | 50 | 150069 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74500 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16800 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 498 |
| `toolbox-roundtrip.js` | 30 | 30 | 224 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2248 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1589 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14168 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 426 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 333 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2735 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 269 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 207 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 285 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 151 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 199 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 216 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 236 |
| `vcc-financial-op-adjustment-archive-chain.js` | 297 | 297 | 579 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1323 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 170 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 445 |
| **合计** | **2459** | **2459** | **297387** |
