...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-06-17T17:30:11+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 587 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 383 |
| `acquiring-engine-migration.js` | 45 | 45 | 4402 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 185 |
| `acquiring-side-db-parity.js` | 19 | 19 | 469 |
...
| `big-table-import-engine.js` | 19 | 19 | 7450 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 255 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4997 |
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 188 |
...
| `pending-engine-migration.js` | 57 | 57 | 5586 |
| `pending-removal-reconcile.js` | 62 | 62 | 239 |
| `statement-generation-pipeline.js` | 45 | 45 | 274 |
| `toolbox-large-file-stream.js` | 15 | 15 | 17564 |
| `toolbox-roundtrip.js` | 30 | 30 | 234 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1881 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1392 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13293 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 314 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 267 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2707 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 291 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 196 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 268 |
