...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-11T12:17:54+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 630 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 417 |
| `acquiring-engine-migration.js` | 45 | 45 | 4652 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 201 |
| `acquiring-side-db-parity.js` | 19 | 19 | 496 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 305 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 254 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 257 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 279 |
| `big-table-import-engine.js` | 19 | 19 | 7461 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 277 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4968 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 313 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 196 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 183 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 173 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 171 |
| `new-account-balance-statement.js` | 36 | 36 | 244 |
| `pending-data-reconciliation.js` | 33 | 33 | 114 |
| `pending-engine-migration.js` | 57 | 57 | 5542 |
| `pending-removal-reconcile.js` | 62 | 62 | 228 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 294 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 298 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 342 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 239 |
| `statement-generation-pipeline.js` | 45 | 45 | 272 |
| `toolbox-large-file-stream.js` | 50 | 50 | 1083479 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 131172 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 15961 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 480 |
| `toolbox-roundtrip.js` | 30 | 30 | 228 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2115 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1544 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13967 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 421 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 331 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2726 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 275 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 212 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 274 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 185 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 184 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 204 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 245 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1154 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1351 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 179 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1018 |
| **合计** | **2372** | **2372** | **1286511** |
