...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-30T00:57:59+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 641 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 415 |
| `acquiring-engine-migration.js` | 45 | 45 | 4673 |
...
| `pending-engine-migration.js` | 57 | 57 | 5762 |
| `pending-removal-reconcile.js` | 62 | 62 | 233 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 284 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 17528 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 16982 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2151 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 473 |
| `toolbox-roundtrip.js` | 30 | 30 | 225 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2056 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1515 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13646 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 348 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 282 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2706 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 273 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 193 |
