...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-17T09:29:20+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 758 |
...
| `acquiring-side-db-parity.js` | 19 | 19 | 556 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 316 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 253 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 257 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 288 |
| `big-table-import-engine.js` | 19 | 19 | 7711 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 306 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5240 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 375 |
...
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 188 |
| `new-account-balance-statement.js` | 36 | 36 | 275 |
| `pending-data-reconciliation.js` | 33 | 33 | 92 |
| `pending-engine-migration.js` | 57 | 57 | 5738 |
| `pending-removal-reconcile.js` | 62 | 62 | 241 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 317 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 315 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 350 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 259 |
| `statement-generation-pipeline.js` | 45 | 45 | 296 |
| `toolbox-large-file-stream.js` | 50 | 50 | 154191 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 164939 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17272 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 528 |
| `toolbox-roundtrip.js` | 30 | 30 | 228 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2330 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1685 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14439 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 488 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 372 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2771 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 295 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 221 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 303 |
...
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1283 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1444 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 192 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1077 |
| **合计** | **2385** | **2385** | **395255** |
