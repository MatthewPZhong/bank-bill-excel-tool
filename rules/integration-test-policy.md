...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-01T23:15:41+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 651 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 426 |
| `acquiring-engine-migration.js` | 45 | 45 | 4758 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 189 |
| `acquiring-side-db-parity.js` | 19 | 19 | 503 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 301 |
...
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 161 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 160 |
| `new-account-balance-statement.js` | 36 | 36 | 249 |
| `pending-data-reconciliation.js` | 33 | 33 | 113 |
| `pending-engine-migration.js` | 57 | 57 | 5783 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 153618 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74247 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16424 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 512 |
| `toolbox-roundtrip.js` | 30 | 30 | 236 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2080 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1534 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13894 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 361 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 296 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2727 |
...
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 235 |
| **合计** | **2051** | **2051** | **297087** |
