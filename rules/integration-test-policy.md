...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-11T17:14:22+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 685 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 456 |
| `acquiring-engine-migration.js` | 45 | 45 | 4870 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 207 |
| `acquiring-side-db-parity.js` | 19 | 19 | 530 |
...
| `bizop-flow-engine-migration.js` | 65 | 65 | 5218 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 337 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 198 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 187 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 178 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 179 |
| `new-account-balance-statement.js` | 36 | 36 | 260 |
| `pending-data-reconciliation.js` | 33 | 33 | 109 |
| `pending-engine-migration.js` | 57 | 57 | 5764 |
| `pending-removal-reconcile.js` | 62 | 62 | 235 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 152948 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 77569 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16900 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 502 |
| `toolbox-roundtrip.js` | 30 | 30 | 225 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2192 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1615 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13913 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 432 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 342 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2736 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 255 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 209 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 291 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 159 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 195 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 210 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 249 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1223 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1467 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 181 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1040 |
| **合计** | **2385** | **2385** | **304806** |
