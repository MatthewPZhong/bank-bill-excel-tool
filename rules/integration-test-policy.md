...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-09-15T22:16:39+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 733 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 500 |
| `acquiring-engine-migration.js` | 45 | 45 | 4219 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 186 |
| `acquiring-side-db-parity.js` | 19 | 19 | 500 |
| `archive-center-permanent-delete.js` | 49 | 49 | 25159 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 103 |
| `background-execution-recovery-canary.js` | 9 | 9 | 108 |
| `background-execution-recovery-control.js` | 27 | 27 | 85 |
| `bank-bu-background-dual-parser.js` | 9 | 9 | 245 |
| `bank-bu-background-single-jobs.js` | 21 | 21 | 462 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 281 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 188 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 193 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 252 |
| `big-table-import-engine.js` | 19 | 19 | 7448 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 294 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 4680 |
| `duplicate-inbound-match-end-to-end.js` | 31 | 31 | 320 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 168 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 187 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 168 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 176 |
| `new-account-balance-statement.js` | 36 | 36 | 209 |
| `pending-data-reconciliation.js` | 33 | 33 | 44 |
| `pending-engine-migration.js` | 57 | 57 | 4650 |
| `pending-removal-reconcile.js` | 62 | 62 | 185 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 233 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 245 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 292 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 178 |
| `statement-generation-pipeline.js` | 45 | 45 | 212 |
| `toolbox-large-file-stream.js` | 50 | 50 | 130281 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 247434 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 14017 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 426 |
| `toolbox-roundtrip.js` | 30 | 30 | 162 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2498 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1814 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13740 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 693 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 453 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2737 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 206 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 181 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 225 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 135 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 202 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 202 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 228 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1141 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1346 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 119 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 985 |
| **合计** | **2537** | **2537** | **472128** |
