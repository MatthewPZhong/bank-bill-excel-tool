...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-26T12:19:37+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 745 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 484 |
| `acquiring-engine-migration.js` | 45 | 45 | 4066 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 164 |
| `acquiring-side-db-parity.js` | 19 | 19 | 498 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 98 |
| `background-execution-recovery-canary.js` | 9 | 9 | 112 |
| `background-execution-recovery-control.js` | 27 | 27 | 86 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 270 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 197 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 192 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 246 |
| `big-table-import-engine.js` | 19 | 19 | 7472 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 274 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 4851 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 307 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 159 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 164 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 159 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 161 |
| `new-account-balance-statement.js` | 36 | 36 | 219 |
| `pending-data-reconciliation.js` | 33 | 33 | 49 |
| `pending-engine-migration.js` | 57 | 57 | 4778 |
| `pending-removal-reconcile.js` | 62 | 62 | 190 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 242 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 254 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 300 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 185 |
| `statement-generation-pipeline.js` | 45 | 45 | 222 |
| `toolbox-large-file-stream.js` | 50 | 50 | 134707 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74516 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 14926 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 455 |
| `toolbox-roundtrip.js` | 30 | 30 | 173 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2407 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1759 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13984 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 580 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 401 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2750 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 218 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 183 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 242 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 116 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 199 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 200 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 228 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1197 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1415 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 128 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1025 |
| **合计** | **2455** | **2455** | **278953** |
