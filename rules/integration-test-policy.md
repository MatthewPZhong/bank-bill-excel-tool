...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-01T07:13:37+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 798 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 395 |
| `acquiring-engine-migration.js` | 45 | 45 | 3585 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 132 |
| `acquiring-side-db-parity.js` | 19 | 19 | 571 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 223 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 188 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 186 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 202 |
| `big-table-import-engine.js` | 19 | 19 | 7377 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 222 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4422 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 251 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 132 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 133 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 127 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 131 |
| `new-account-balance-statement.js` | 36 | 36 | 203 |
| `pending-data-reconciliation.js` | 33 | 33 | 55 |
| `pending-engine-migration.js` | 57 | 57 | 4869 |
| `pending-removal-reconcile.js` | 62 | 62 | 175 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 223 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 235 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 269 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 176 |
| `statement-generation-pipeline.js` | 45 | 45 | 205 |
| `toolbox-large-file-stream.js` | 50 | 50 | 124038 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 71979 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 12779 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 410 |
| `toolbox-roundtrip.js` | 30 | 30 | 161 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2534 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1856 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13175 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 281 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 241 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2769 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 207 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 140 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 225 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 100 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 156 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 153 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 180 |
| **合计** | **2051** | **2051** | **256869** |
