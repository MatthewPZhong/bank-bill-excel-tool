...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-08T22:53:57+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 676 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 467 |
| `acquiring-engine-migration.js` | 45 | 45 | 4888 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 197 |
| `acquiring-side-db-parity.js` | 19 | 19 | 521 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 307 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 255 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 258 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 285 |
| `big-table-import-engine.js` | 19 | 19 | 7574 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 297 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5250 |
...
| `pending-engine-migration.js` | 57 | 57 | 5852 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 148362 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 73109 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16569 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 508 |
| `toolbox-roundtrip.js` | 30 | 30 | 226 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2168 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1594 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13851 |
...
| `vcc-financial-op-adjustment-archive-chain.js` | 55 | 55 | 504 |
| `vcc-financial-op-destructive-state-chain.js` | 52 | 52 | 1150 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 433 |
| **合计** | **2186** | **2186** | **293585** |
