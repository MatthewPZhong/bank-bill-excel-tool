...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-28T13:29:07+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 431 |
| `acquiring-engine-migration.js` | 45 | 45 | 4397 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 160 |
| `acquiring-side-db-parity.js` | 19 | 19 | 482 |
...
| `bank-statement-universal-import-routing.js` | 20 | 20 | 241 |
| `big-table-import-engine.js` | 19 | 19 | 7502 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 295 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4846 |
...
| `new-account-balance-statement.js` | 36 | 36 | 243 |
| `pending-data-reconciliation.js` | 33 | 33 | 105 |
| `pending-engine-migration.js` | 57 | 57 | 5527 |
| `pending-removal-reconcile.js` | 62 | 62 | 215 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 239 |
...
| `statement-generation-pipeline.js` | 45 | 45 | 243 |
| `toolbox-large-file-stream.js` | 15 | 15 | 17201 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 16382 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2081 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 454 |
| `toolbox-roundtrip.js` | 30 | 30 | 225 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1947 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1477 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13644 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 364 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 314 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2694 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 246 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 184 |
