...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-22T01:24:28+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 683 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 438 |
| `acquiring-engine-migration.js` | 45 | 45 | 4720 |
...
| `bizop-flow-engine-migration.js` | 65 | 65 | 5291 |
...
| `pending-engine-migration.js` | 57 | 57 | 5823 |
...
| `toolbox-large-file-stream.js` | 15 | 15 | 18459 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 17555 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2234 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 483 |
| `toolbox-roundtrip.js` | 30 | 30 | 229 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2172 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1590 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14680 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 375 |
...
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 305 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 141 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 252 |
