...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-28T15:41:27+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 239 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 253 |
...
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1074 |
| `v2.1.10-a3-phase2.js` | 33 | 33 | 661 |
| `v2.1.10-a4-phase3.js` | 40 | 40 | 18551 |
| `v2.1.10-n4-cont-1-phase4.js` | 23 | 23 | 199 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 170 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 230 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 131 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 257 |
| `v2.1.9-sr-log-1.js` | 35 | 35 | 119 |
| **合计** | **824** | **824** | **22760** |
