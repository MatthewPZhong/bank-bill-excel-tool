...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-11T16:04:57+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 666 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 446 |
| `acquiring-engine-migration.js` | 45 | 45 | 4774 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 198 |
| `acquiring-side-db-parity.js` | 19 | 19 | 516 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 308 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 258 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 261 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 287 |
| `big-table-import-engine.js` | 19 | 19 | 7563 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 307 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5117 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 315 |
...
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 177 |
| `new-account-balance-statement.js` | 36 | 36 | 239 |
| `pending-data-reconciliation.js` | 33 | 33 | 110 |
| `pending-engine-migration.js` | 57 | 57 | 5634 |
...
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 247 |
| `statement-generation-pipeline.js` | 45 | 45 | 284 |
| `toolbox-large-file-stream.js` | 50 | 50 | 149382 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74730 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16322 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 484 |
| `toolbox-roundtrip.js` | 30 | 30 | 232 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2123 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1571 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14061 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 431 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 343 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2726 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 274 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 211 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 283 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 160 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 189 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 209 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 250 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1188 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1429 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 180 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1037 |
| **合计** | **2385** | **2385** | **297272** |
