...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-18T04:59:45+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 739 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 497 |
| `acquiring-engine-migration.js` | 45 | 45 | 4916 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 207 |
| `acquiring-side-db-parity.js` | 19 | 19 | 559 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 319 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 259 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 253 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 290 |
| `big-table-import-engine.js` | 19 | 19 | 7605 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 304 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5072 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 356 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 197 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 205 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 201 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 205 |
| `new-account-balance-statement.js` | 36 | 36 | 264 |
| `pending-data-reconciliation.js` | 33 | 33 | 94 |
| `pending-engine-migration.js` | 57 | 57 | 5619 |
| `pending-removal-reconcile.js` | 62 | 62 | 228 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 294 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 301 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 349 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 231 |
| `statement-generation-pipeline.js` | 45 | 45 | 269 |
| `toolbox-large-file-stream.js` | 50 | 50 | 152322 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 166857 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17087 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 503 |
| `toolbox-roundtrip.js` | 30 | 30 | 220 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2388 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1750 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14530 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 559 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 408 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2758 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 250 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 216 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 288 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 157 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 215 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 221 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 265 |
| `vcc-financial-op-adjustment-archive-chain.js` | 209 | 209 | 1250 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1424 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 176 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1089 |
| **合计** | **2385** | **2385** | **394766** |
