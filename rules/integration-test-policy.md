...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-28T13:42:22+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 242 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 237 |
| `new-account-balance-statement.js` | 36 | 36 | 262 |
| `pending-data-reconciliation.js` | 33 | 33 | 99 |
| `statement-generation-pipeline.js` | 45 | 45 | 240 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1073 |
| `v2.1.10-a3-phase2.js` | 33 | 33 | 637 |
| `v2.1.10-a4-phase3.js` | 25 | 25 | 16100 |
| `v2.1.10-n4-cont-1-phase4.js` | 23 | 23 | 188 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 165 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 306 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 134 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 255 |
| `v2.1.9-sr-log-1.js` | 35 | 35 | 125 |
| **合计** | **809** | **809** | **20302** |
