...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-09T14:43:50+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 677 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 444 |
| `acquiring-engine-migration.js` | 45 | 45 | 4811 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 192 |
| `acquiring-side-db-parity.js` | 19 | 19 | 514 |
...
| `big-table-import-engine.js` | 19 | 19 | 7578 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 280 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5170 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 326 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 191 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 182 |
...
| `pending-data-reconciliation.js` | 33 | 33 | 107 |
| `pending-engine-migration.js` | 57 | 57 | 5721 |
...
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 341 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 237 |
| `statement-generation-pipeline.js` | 45 | 45 | 270 |
| `toolbox-large-file-stream.js` | 50 | 50 | 150291 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 73681 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16292 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 494 |
| `toolbox-roundtrip.js` | 30 | 30 | 223 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2128 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1565 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13744 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 425 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 327 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2733 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 268 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 204 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 282 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 155 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 200 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 214 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 243 |
| `vcc-financial-op-adjustment-archive-chain.js` | 297 | 297 | 562 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1275 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 171 |
