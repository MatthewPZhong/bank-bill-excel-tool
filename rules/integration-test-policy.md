...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-09T10:52:56+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 672 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 407 |
| `acquiring-engine-migration.js` | 45 | 45 | 3807 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 149 |
| `acquiring-side-db-parity.js` | 19 | 19 | 486 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 256 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 200 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 199 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 235 |
| `big-table-import-engine.js` | 19 | 19 | 7540 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 249 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4386 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 290 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 143 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 150 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 143 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 144 |
| `new-account-balance-statement.js` | 36 | 36 | 223 |
| `pending-data-reconciliation.js` | 33 | 33 | 47 |
| `pending-engine-migration.js` | 57 | 57 | 4787 |
| `pending-removal-reconcile.js` | 62 | 62 | 191 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 247 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 257 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 298 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 190 |
| `statement-generation-pipeline.js` | 45 | 45 | 225 |
| `toolbox-large-file-stream.js` | 50 | 50 | 132335 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 74691 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 15024 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 455 |
| `toolbox-roundtrip.js` | 30 | 30 | 174 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2182 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1577 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13979 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 441 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 323 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2715 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 214 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 170 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 251 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 98 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 191 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 190 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 220 |
| `vcc-financial-op-adjustment-archive-chain.js` | 297 | 297 | 531 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1233 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 121 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 390 |
| **合计** | **2459** | **2459** | **273426** |
