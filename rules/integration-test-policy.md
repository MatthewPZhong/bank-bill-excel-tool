...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-28T18:30:54+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 257 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 264 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 238 |
...
| `v2.1.10-a3-phase1.js` | 40 | 40 | 1109 |
| `v2.1.10-a3-phase2.js` | 42 | 42 | 715 |
| `v2.1.10-a4-phase3.js` | 47 | 47 | 20887 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 304 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 245 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 324 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 149 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 254 |
| `v2.1.9-sr-log-1.js` | 35 | 35 | 126 |
| **合计** | **850** | **850** | **25485** |
