...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-09T07:49:55+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 717 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 432 |
| `acquiring-engine-migration.js` | 45 | 45 | 4110 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 159 |
| `acquiring-side-db-parity.js` | 19 | 19 | 526 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 276 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 214 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 207 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 248 |
| `big-table-import-engine.js` | 19 | 19 | 7504 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 257 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4637 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 307 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 151 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 163 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 153 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 155 |
| `new-account-balance-statement.js` | 36 | 36 | 235 |
| `pending-data-reconciliation.js` | 33 | 33 | 51 |
| `pending-engine-migration.js` | 57 | 57 | 5107 |
| `pending-removal-reconcile.js` | 62 | 62 | 198 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 260 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 271 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 317 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 202 |
| `statement-generation-pipeline.js` | 45 | 45 | 237 |
| `toolbox-large-file-stream.js` | 50 | 50 | 135137 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 75536 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 14670 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 449 |
| `toolbox-roundtrip.js` | 30 | 30 | 171 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2148 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1586 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13623 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 407 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 302 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2699 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 217 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 157 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 238 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 94 |
...
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1211 |
