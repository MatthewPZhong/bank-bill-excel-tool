...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-03T16:07:02+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 668 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 450 |
| `acquiring-engine-migration.js` | 45 | 45 | 4818 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 197 |
| `acquiring-side-db-parity.js` | 19 | 19 | 523 |
...
| `big-table-import-engine.js` | 19 | 19 | 7627 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 305 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 5222 |
...
| `pending-engine-migration.js` | 57 | 57 | 5787 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 148534 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 72655 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 16753 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 495 |
| `toolbox-roundtrip.js` | 30 | 30 | 223 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2110 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1578 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13799 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 411 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 320 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2723 |
