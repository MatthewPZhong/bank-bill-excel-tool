...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-28T12:00:02+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 219 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 211 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 220 |
...
| `v2.1.10-a3-phase2.js` | 31 | 31 | 588 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 223 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 112 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 233 |
| `v2.1.9-sr-log-1.js` | 35 | 35 | 105 |
| **合计** | **716** | **716** | **3484** |
