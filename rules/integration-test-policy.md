...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-07-21T10:31:48+08:00 -->
...
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 391 |
| `acquiring-engine-migration.js` | 45 | 45 | 3845 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 148 |
| `acquiring-side-db-parity.js` | 19 | 19 | 501 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 258 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 216 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 207 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 237 |
| `big-table-import-engine.js` | 19 | 19 | 7569 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 250 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4592 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 297 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 138 |
| `gateway-channel-filter-equivalence.js` | 15 | 15 | 145 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 141 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 142 |
| `new-account-balance-statement.js` | 36 | 36 | 243 |
| `pending-data-reconciliation.js` | 33 | 33 | 51 |
| `pending-engine-migration.js` | 57 | 57 | 5066 |
| `pending-removal-reconcile.js` | 62 | 62 | 200 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 313 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 197 |
| `statement-generation-pipeline.js` | 45 | 45 | 237 |
| `toolbox-large-file-stream.js` | 15 | 15 | 18482 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 17724 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 2164 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 440 |
| `toolbox-roundtrip.js` | 30 | 30 | 181 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2163 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1570 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14068 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 349 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 258 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2702 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 225 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 157 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 251 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 83 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 181 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 176 |
