...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-24T18:08:00+08:00 -->
...
| `acquiring-index-slim-v2.js` | 22 | 22 | 216 |
| `acquiring-side-db-parity.js` | 19 | 19 | 555 |
| `background-execution-pure-compute-canary.js` | 9 | 9 | 166 |
| `background-execution-recovery-canary.js` | 9 | 9 | 156 |
| `background-execution-recovery-control.js` | 27 | 27 | 132 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 292 |
| `bank-statement-hit-scenario-report.js` | 49 | 49 | 261 |
| `bank-statement-many-to-many-review-sheet.js` | 33 | 33 | 247 |
| `bank-statement-universal-import-routing.js` | 20 | 20 | 302 |
| `big-table-import-engine.js` | 19 | 19 | 7611 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 333 |
| `bizop-flow-engine-migration.js` | 73 | 73 | 5803 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 357 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 210 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 213 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 203 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 205 |
| `new-account-balance-statement.js` | 36 | 36 | 270 |
| `pending-data-reconciliation.js` | 33 | 33 | 113 |
| `pending-engine-migration.js` | 57 | 57 | 5784 |
| `pending-removal-reconcile.js` | 62 | 62 | 244 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 303 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 312 |
| `pre-fund-reconciliation-side-db-parity.js` | 69 | 69 | 351 |
| `refund-backfill-yellow-fill-e2e.js` | 258 | 258 | 246 |
| `statement-generation-pipeline.js` | 45 | 45 | 283 |
| `toolbox-large-file-stream.js` | 50 | 50 | 149672 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 75246 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 17211 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 504 |
| `toolbox-roundtrip.js` | 30 | 30 | 230 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2336 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1728 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 14070 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 568 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 416 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2774 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 290 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 230 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 296 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 177 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 206 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 233 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 270 |
| `vcc-financial-op-adjustment-archive-chain.js` | 226 | 226 | 1272 |
| `vcc-financial-op-destructive-state-chain.js` | 77 | 77 | 1430 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 188 |
| `vcc-financial-op-historical-template-export.js` | 29 | 29 | 1055 |
| **合计** | **2455** | **2455** | **301907** |
