...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-08-11T06:25:14+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 621 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 434 |
| `acquiring-engine-migration.js` | 45 | 45 | 4640 |
| `acquiring-index-slim-v2.js` | 22 | 22 | 195 |
| `acquiring-side-db-parity.js` | 19 | 19 | 489 |
| `bank-bu-recon-side-db-parity.js` | 17 | 17 | 303 |
...
| `big-table-import-engine.js` | 19 | 19 | 7504 |
| `biz-op-recon-side-db-parity.js` | 16 | 16 | 299 |
| `bizop-flow-engine-migration.js` | 65 | 65 | 4958 |
| `duplicate-inbound-match-end-to-end.js` | 28 | 28 | 317 |
| `fund-transfer-recon-account-mapping.js` | 19 | 19 | 195 |
| `gateway-channel-filter-equivalence.js` | 23 | 23 | 180 |
| `linked-fx-open7-stale-hit-e2e.js` | 27 | 27 | 172 |
| `linked-table-delete-by-range-tablekey.js` | 73 | 73 | 169 |
| `new-account-balance-statement.js` | 36 | 36 | 242 |
| `pending-data-reconciliation.js` | 33 | 33 | 116 |
| `pending-engine-migration.js` | 57 | 57 | 5554 |
| `pending-removal-reconcile.js` | 62 | 62 | 223 |
| `position-reconciliation-side-db-parity.js` | 38 | 38 | 289 |
| `pre-fund-reconciliation-output-contract.js` | 15 | 15 | 303 |
...
| `toolbox-large-file-stream.js` | 50 | 50 | 142840 |
| `toolbox-large-split-multi-sheet.js` | 31 | 31 | 70525 |
| `toolbox-multi-sheet-merge.js` | 16 | 16 | 15978 |
| `toolbox-multi-split-roundtrip.js` | 17 | 17 | 485 |
| `toolbox-roundtrip.js` | 30 | 30 | 234 |
| `v2.1.10-a3-phase1.js` | 40 | 40 | 2028 |
| `v2.1.10-a3-phase2.js` | 56 | 56 | 1523 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 13585 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 418 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 336 |
| `v2.1.12-beta-multiworker-nested.js` | - | - | 2712 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 275 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 213 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 279 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 165 |
| `v3.0.0-linked-streaming-import.js` | 19 | 19 | 183 |
| `v3.0.1-linked-gateway-upsert.js` | 40 | 40 | 203 |
| `v3.0.4-boc-dispatch-order-fix.js` | 31 | 31 | 243 |
| `vcc-financial-op-adjustment-archive-chain.js` | 297 | 297 | 538 |
| `vcc-financial-op-destructive-state-chain.js` | 64 | 64 | 1238 |
| `vcc-financial-op-effective-result.js` | 19 | 19 | 181 |
| `vcc-financial-op-historical-template-export.js` | 28 | 28 | 396 |
| **合计** | **2459** | **2459** | **283436** |
