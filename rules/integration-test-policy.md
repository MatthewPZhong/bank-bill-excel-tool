...
<!-- auto-generated by scripts/integration-runner.js, last-updated: 2026-05-31T16:10:38+08:00 -->
<!-- DO NOT EDIT MANUALLY — modify scripts/integration/*.js then re-run `npm run test:integration` -->

| 脚本 | 用例数 | 断言数 | 耗时 (ms) |
|---|---|---|---|
| `acquiring-bill-currency-idle-cleanup.js` | 38 | 38 | 229 |
| `acquiring-bill-currency-n4-migration.js` | 128 | 128 | 243 |
| `bank-statement-hit-scenario-report.js` | 47 | 47 | 248 |
...
| `v2.1.10-a3-phase2.js` | 56 | 56 | 729 |
| `v2.1.10-a4-phase3.js` | 75 | 75 | 26054 |
| `v2.1.10-n4-cont-1-phase4.js` | 33 | 33 | 223 |
| `v2.1.10-n4-cont-2-phase5.js` | 43 | 43 | 167 |
| `v2.1.9-n5-end-to-end.js` | 68 | 68 | 311 |
| `v2.1.9-n5-migration.js` | 67 | 67 | 125 |
| `v2.1.9-sr-fix-1-coverage.js` | 148 | 148 | 255 |
| `v2.1.9-sr-log-1.js` | 33 | 33 | 128 |
| **合计** | **952** | **952** | **30560** |
