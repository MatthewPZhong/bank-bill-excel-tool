...
> ⚠️ **以下 §3.3.4 / §3.3.5 为 v0.1 设计快照**。Fix1 round（v0.2）对若干行为做了撤回/修订，最终行为以本 PRD §八「Round Fix1」 + USER_GUIDE §1.8 + spec.md 顶部 v0.2 修订 Note 为准。下表行末标记 [v0.1] = 历史方案、[Fix1] = 当前生效方案。
