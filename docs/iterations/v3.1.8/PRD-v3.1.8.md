...
v3.1.8 已合入 `main`，主干 fresh Windows release-check、x64 构建和包内分发守卫均已通过，但当前仍是发布候选。正式发布前必须完成 [preflight「仍阻塞 v3.1.8 正式发布」](../../../changes/3.1.8/preflight.md#仍阻塞-v318-正式发布)，包括：
