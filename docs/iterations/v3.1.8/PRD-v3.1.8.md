...
## 0. 上线后纠错补遗（前向至 v3.1.9）

v3.1.8 正式发布后发现的 VCC 财务 OP 大库卡顿与标准 v3.1.7 四数据集归档兼容问题，已在[纠错补遗索引](../../../changes/3.1.8/erratum/README.md)中冻结为 [Spec v2](../../../changes/3.1.8/erratum/VCC财务OP-3.1.8卡顿与旧归档兼容纠错Spec-v2.md) 与 [TechDoc v1.1](../../../changes/3.1.8/erratum/VCC财务OP-3.1.8卡顿与旧归档兼容纠错TechDoc-v1.1.md)。补遗只前向约束 v3.1.9 的实现与发布，不表示已发布的 v3.1.8 二进制包含纠错实现。

原锁定规格、规范化 SHA-256 `1f5f0663ee35436c8b1f7da628822a4f83a3f70db215cd5ebd60a6720bae367d`、v3.1.8 Release 身份及人工 `6/6 PASS` 继续作为历史事实，不因补遗而被改写。
