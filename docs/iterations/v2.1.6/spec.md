...
| 字段 | 值 |
|---|---|
| 文档版本 | v0.18（2026-05-20 — PR #50 round 2 reviewer findings 修复：NewF1 [P1] spec Case O 描述错（code 保留正确）+ NewF2 [P2] success-no-files + NewF3 [P2] header detailLines 透传 + CodexP1 [P1] sub-sheet 防御 + CodexP2 [P2] header 不 truncate）；v0.17 = PR #50 round 1 F1+F2+F3；v0.16 = fix15 弹窗标题三分支；v0.15 = fix14 UI 镜像布局；v0.14 = fix11/12/13；v0.13-v0.1 起草 |
