...
pr: 81
version: v3.0.11
merged: 2026-06-28 (1f14520)
integrated: false  # 无独立 PRD（v3.0.11 用 changes/ spec 记录），实施记录见 changes/r5s3-debit-zero-bucket-gate + changes/bank-statement-async-import-run
---
