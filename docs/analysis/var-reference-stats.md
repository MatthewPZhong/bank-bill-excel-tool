...
|---|---:|---:|---:|---|
| `path` | 28 | 89 | 25 | src/backend/balance-adjustment-store.js |
| `fs` | 22 | 60 | 22 | src/backend/balance-adjustment-store.js |
...
| `elements` | 4 | 136 | 1 | src/renderer.js |
...
| `validateHeaders` | 4 | 12 | 2 | src/backend/pending-import/validator.js |
...
| `FLOW_HEADERS` | 4 | 8 | 1 | src/backend/biz-op-recon-db/columns.js |
...
| `insertRun` | 4 | 6 | 2 | src/backend/bank-bu-recon-db/run-repository.js |
...
| `ExcelJS` | 3 | 11 | 3 | src/main-process/bank-bu-recon-writer.js |
...
| `getRunById` | 3 | 5 | 2 | src/backend/biz-op-recon-db/run-repository.js |
...
| `normalizeHeaderCell` | 8 | src/backend/bank-bu-recon-import/validator.js |
...
| `buildHeaderValidator` | 6 | src/backend/bank-bu-recon-import/validator.js |
...
| `validateFlowHeaders` | 4 | src/backend/biz-op-recon-import/validator.js |
...
|---|---:|---:|---:|---|
| `path` | 28 | 89 | 25 | src/main-process/scenario-engines/c4-recon-id-fix.js(15), src/backend/database/own-accounts-migration.js(6), src/main-process/pending-session.js(6) |
| `fs` | 22 | 60 | 22 | src/backend/usage-stats.js(9), src/backend/database/own-accounts-migration.js(6), src/backend/big-account-mode-store.js(5) |
...
| `dialog` | 5 | 371 | 1 | src/renderer-dialogs.js(267), src/renderer.js(71), src/renderer-pending.js(26) |
...
| `elements` | 4 | 136 | 1 | src/renderer.js(88), src/renderer-previews.js(27), src/renderer-pending.js(17) |
...
| `validateHeaders` | 4 | 12 | 2 | src/backend/bank-bu-recon-import/reader.js(4), src/backend/biz-op-recon-import/reader.js(4), src/backend/pending-import/validator.js(2) |
...
| `FLOW_HEADERS` | 4 | 8 | 1 | src/backend/biz-op-recon-db/columns.js(2), src/backend/biz-op-recon-import/reader.js(2), src/backend/biz-op-recon-import/validator.js(2) |
...
| `insertRun` | 4 | 6 | 2 | src/backend/bank-bu-recon-db/run-repository.js(2), src/backend/biz-op-recon-db/run-repository.js(2), src/main-process/bank-bu-recon-session.js(1) |
...
| `ExcelJS` | 3 | 11 | 3 | src/main-process/biz-op-recon-writer.js(5), src/main-process/bank-bu-recon-writer.js(3), src/main-process/exceljs-writer.js(3) |
...
| `getRunById` | 3 | 5 | 2 | src/backend/biz-op-recon-db/run-repository.js(2), src/backend/pending-db/diff-repository.js(2), src/backend/pending-export/writer.js(1) |
...
| `MODULES` | 2 | 59 | 1 | src/renderer-previews.js(43), src/renderer.js(16) |
...
| `normalizeHeaderCell` | 2 | 8 | 2 | src/backend/bank-bu-recon-import/validator.js(4), src/backend/biz-op-recon-import/validator.js(4) |
...
| `buildHeaderValidator` | 2 | 6 | 2 | src/backend/bank-bu-recon-import/validator.js(3), src/backend/biz-op-recon-import/validator.js(3) |
...
| `validateFlowHeaders` | 2 | 4 | 1 | src/backend/biz-op-recon-import/reader.js(2), src/backend/biz-op-recon-import/validator.js(2) |
