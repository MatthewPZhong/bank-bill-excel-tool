...
| `state` | 42 | 672 | 1 | src/renderer.js |
...
| `state` | 42 | 672 | 1 | src/renderer.js(214), src/backend/vcc-financial-op/dataset-deletion.js(59), src/renderer-pending.js(55) |
