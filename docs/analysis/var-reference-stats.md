...
| `sanitizeSheetName` | 5 | src/backend/pending-export/writer.js |
...
| `sanitizeSheetName` | 2 | 5 | 2 | src/backend/pending-export/writer.js(3), src/main-process/acquiring-bill-currency-writer.js(2) |
