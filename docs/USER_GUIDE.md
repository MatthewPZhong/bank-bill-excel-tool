...
> 发布说明：v3.1.9 已于 2026-08-13 通过受控 Windows Release workflow 正式发布。annotated tag、latest stable Release 和 Setup/portable/blockmap/`latest.yml` 四项公开资产均已完成回读。Windows installer/portable 实际运行、Excel/WPS、约 16 GB、约 700 万行、目标生产库和资金人工复核仍待完成，技术 Release 不替代这些人工验证。
