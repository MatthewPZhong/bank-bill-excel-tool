...
自动化门禁已通过：unit **3544/3544**、integration **40 个脚本 / 1870/1870**、smoke、ESLint，并完成多月份 MPT 基准、9 万行真实单据流读、启动性能和 Electron 预览。真实样本自动回放得到 **9 个成功组、1 个人工组**；Windows Excel/WPS 视觉检查与资金负责人复核仍是发布硬门禁。
