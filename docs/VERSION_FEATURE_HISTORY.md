...
- **新模块「业务OP数据核对」**：每日维度对账模块（第 5 个主模块）
  ...
  - **round 5 self-review 修订**（v0.10.1 — 2026-05-14，round 4 完成后 Codex 自动 review 反馈）：1 P3 — 4 处归档文档残留旧口径"17 IPC trackedIpcHandle"，全部统一改为"5 tracked + 10 plain = 15 IPC"。无代码改动 / 无 smoke 改动 — 纯文档口径回填。
